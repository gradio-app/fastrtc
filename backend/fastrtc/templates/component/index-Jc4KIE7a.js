...
var xu = 0, xl = 1, ra = 2, xr = 3, Za = 4, k0 = 5, sa = 6, Gt = 7, $0 = [new Wr(xu, 0, !1), new Wr(xl, 0, !0), new Wr(ra, 1, !1), new Wr(xr, 1, !0), new Wr(Za, 2, !1), new Wr(k0, 2, !0), new Wr(sa, 3, !1), new Wr(Gt, 3, !0)], N5 = [Za, k0, Za, k0, sa, Gt, sa, Gt], R5 = [k0, k0, k0, k0, Gt, Gt, Gt, Gt], O5 = [ra, xr, Za, k0, sa, Gt, sa, Gt], q5 = [xr, xr, k0, k0, Gt, Gt, Gt, Gt], P5 = [xl, xl, xr, xr, k0, k0, Gt, Gt], H5 = [xu, xl, ra, xr, ra, xr, ra, xr], le = {
  DISPLAY: $0[xu],
  TEXT: $0[ra],
  SCRIPT: $0[Za],
  SCRIPTSCRIPT: $0[sa]
...
var Xo = {
  ...
  var t = "<" + e;
  this.classes.length && (t += ' class="' + ae.escape(sn(this.classes)) + '"');
  var r = "";
...
class x0 {
  ...
  toNode() {
    ...
    this.italic > 0 && (t = document.createElement("span"), t.style.marginRight = X(this.italic)), this.classes.length > 0 && (t = t || document.createElement("span"), t.className = sn(this.classes));
    for (var r in this.style)
  ...
  toMarkup() {
    var e = !1, t = "<span";
    this.classes.length && (e = !0, t += ' class="', t += ae.escape(sn(this.classes)), t += '"');
    var r = "";
...
var m = "math", H = "text", _ = "main", A = "ams", Ge = "accent-token", K = "bin", Jt = "close", oa = "inner", ie = "mathord", ct = "op-token", m0 = "open", Zl = "punct", x = "rel", Pr = "spacing", F = "textord";
f(m, _, x, "≡", "\\equiv", !0);
f(m, _, x, "≺", "\\prec", !0);
f(m, _, x, "≻", "\\succ", !0);
f(m, _, x, "∼", "\\sim", !0);
...
f(m, A, K, "⊡", "\\boxdot", !0);
f(m, _, K, "△", "\\bigtriangleup");
f(m, _, K, "▽", "\\bigtriangledown");
f(m, _, K, "†", "\\dagger");
f(m, _, K, "⋄", "\\diamond");
f(m, _, K, "⋆", "\\star");
f(m, _, K, "◃", "\\triangleleft");
f(m, _, K, "▹", "\\triangleright");
f(m, _, m0, "{", "\\{");
f(H, _, F, "{", "\\{");
...
for (var Ut = 0; Ut < Tl.length; Ut++) {
  var Qe = Tl.charAt(Ut);
  oe = String.fromCharCode(55349, 56320 + Ut), f(m, _, ie, Qe, oe), f(H, _, F, Qe, oe), oe = String.fromCharCode(55349, 56372 + Ut), f(m, _, ie, Qe, oe), f(H, _, F, Qe, oe), oe = String.fromCharCode(55349, 56424 + Ut), f(m, _, ie, Qe, oe), f(H, _, F, Qe, oe), oe = String.fromCharCode(55349, 56580 + Ut), f(m, _, ie, Qe, oe), f(H, _, F, Qe, oe), oe = String.fromCharCode(55349, 56684 + Ut), f(m, _, ie, Qe, oe), f(H, _, F, Qe, oe), oe = String.fromCharCode(55349, 56736 + Ut), f(m, _, ie, Qe, oe), f(H, _, F, Qe, oe), oe = String.fromCharCode(55349, 56788 + Ut), f(m, _, ie, Qe, oe), f(H, _, F, Qe, oe), oe = String.fromCharCode(55349, 56840 + Ut), f(m, _, ie, Qe, oe), f(H, _, F, Qe, oe), oe = String.fromCharCode(55349, 56944 + Ut), f(m, _, ie, Qe, oe), f(H, _, F, Qe, oe), Ut < 26 && (oe = String.fromCharCode(55349, 56632 + Ut), f(m, _, ie, Qe, oe), f(H, _, F, Qe, oe), oe = String.fromCharCode(55349, 56476 + Ut), f(m, _, ie, Qe, oe), f(H, _, F, Qe, oe));
}
oe = "𝕜";
f(m, _, ie, "k", oe);
f(H, _, F, "k", oe);
for (var _n = 0; _n < 10; _n++) {
  var Xr = _n.toString();
  oe = String.fromCharCode(55349, 57294 + _n), f(m, _, ie, Xr, oe), f(H, _, F, Xr, oe), oe = String.fromCharCode(55349, 57314 + _n), f(m, _, ie, Xr, oe), f(H, _, F, Xr, oe), oe = String.fromCharCode(55349, 57324 + _n), f(m, _, ie, Xr, oe), f(H, _, F, Xr, oe), oe = String.fromCharCode(55349, 57334 + _n), f(m, _, ie, Xr, oe), f(H, _, F, Xr, oe);
}
var Zo = "ÐÞþ";
for (var Qs = 0; Qs < Zo.length; Qs++) {
  var Pi = Zo.charAt(Qs);
  f(m, _, ie, Pi, Pi), f(H, _, F, Pi, Pi);
}
var Hi = [
  ...
  for (var c = [], d = a, h = a, p = a, g = 0; g < r.length; g++) {
    ...
    if (v.type === "kern")
      ...
      w.style.top = X(-i - p - k.depth), v.marginLeft && (w.style.marginLeft = v.marginLeft), v.marginRight && (w.style.marginRight = v.marginRight), c.push(w), p += k.height + k.depth;
    }
  ...
  var S;
  if (d < 0) {
    var T = r0([], []), B = r0(["vlist"], [T]);
    B.style.height = X(-d);
    var C = r0(["vlist-s"], [new x0("​")]);
    S = [r0(["vlist-r"], [E, C]), r0(["vlist-r"], [B])];
  } else
    S = [r0(["vlist-r"], [E])];
  var I = r0(["vlist-t"], S);
  return S.length === 2 && I.classes.push("vlist-t2"), I.height = h, I.depth = -d, I;
}, b3 = (n, e) => {
...
var Ml = function(e) {
...
}, Ir = R.makeSpan, D3 = ["leftmost", "mbin", "mopen", "mrel", "mop", "mpunct"], A3 = ["rightmost", "mrel", "mclose", "mpunct"], E3 = {
  display: le.DISPLAY,
  text: le.TEXT,
  script: le.SCRIPT,
  ...
  return rc(i, (g, v) => {
    ...
    k === "mbin" && ae.contains(A3, D) ? v.classes[0] = "mord" : D === "mbin" && ae.contains(D3, k) && (g.classes[0] = "mord");
  }, {
    node: d
  }, h, p), rc(i, (g, v) => {
    var k = Ko(v), D = Ko(g), y = k && D ? g.hasClass("mtight") ? k3[k][D] : y3[k][D] : null;
    if (y)
      return R.makeGlue(y, u);
  }, {
    node: d
  }, h, p), i;
...
class y0 {
  ...
  toMarkup() {
    ...
    this.classes.length > 0 && (e += ' class ="' + ae.escape(sn(this.classes)) + '"'), e += ">";
    for (var r = 0; r < this.children.length; r++)
      e += this.children[r].toMarkup();
...
var U = {
  ...
  return Re[t][e] && Re[t][e].replace && e.charCodeAt(0) !== 55349 && !(Fd.hasOwnProperty(e) && r && (r.fontFamily && r.fontFamily.slice(4, 6) === "tt" || r.font && r.font.slice(4, 6) === "tt")) && (e = Re[t][e].replace), new U.TextNode(e);
}, Mu = function(e) {
  ...
  return Tu(i, l, a) ? R.fontMap[r].variant : null;
}, l0 = function(e, t, r) {
  if (e.length === 1) {
    var a = Le(e[0], t);
...
var Od = function(e) {
  ...
  var a = Od(r), i = Jo(e, a), l = R.makeSpan(["katex"], [i]);
  return qd(l, r);
}, M3 = {
  widehat: "^",
  widecheck: "ˇ",
  ...
  function r() {
    ...
    if (ae.contains(["widehat", "widecheck", "widetilde", "utilde"], o)) {
      ...
      return {
        span: R.makeSvgSpan([], [k], t),
        minWidth: 0,
        height: p
      };
    } else {
      var D = [], y = B3[o], [w, E, S] = y, T = S / 1e3, B = w.length, C, I;
      if (B === 1) {
        var N = y[3];
        C = ["hide-tail"], I = [N];
      } else if (B === 2)
        C = ["halfarrow-left", "halfarrow-right"], I = ["xMinYMin", "xMaxYMin"];
      else if (B === 3)
        C = ["brace-left", "brace-center", "brace-right"], I = ["xMinYMin", "xMidYMin", "xMaxYMin"];
      else
        throw new Error(`Correct katexImagesData or update code here to support
                    ` + B + " children.");
      for (var L = 0; L < B; L++) {
        var q = new on(w[L]), Q = new Br([q], {
          width: "400em",
          height: X(T),
          viewBox: "0 0 " + s + " " + S,
          preserveAspectRatio: I[L] + " slice"
        }), z = R.makeSvgSpan([C[L]], [Q], t);
        if (B === 1)
          return {
            span: z,
            minWidth: E,
        ...
        z.style.height = X(T), D.push(z);
      }
      return {
        span: R.makeSpan(["stretchy"], D, t),
        minWidth: E,
        height: T
      };
    }
...
var Iu = (n, e) => {
  var t, r, a;
  n && n.type === "supsub" ? (r = me(n.base, "accent"), t = r.base, n.base = t, a = i3(Se(n, e)), n.base = r) : (r = me(n, "accent"), t = r.base);
  ...
  if (r.isStretchy)
    ...
    var p, g;
    r.label === "\\vec" ? (p = R.staticSvg("vec", e), g = R.svgData.vec[1]) : (p = R.makeOrd({
      mode: r.mode,
      text: r.label
    }, e, "textord"), p = K1(p), p.italic = 0, g = p.width, c && (d += p.depth)), h = R.makeSpan(["accent-body"], [p]);
    var v = r.label === "\\textcircled";
    v && (h.classes.push("accent-full"), d = i.height);
    var k = s;
    v || (k -= g / 2), h.style.left = X(k), r.label === "\\textcircled" && (h.style.top = ".2em"), h = R.makeVList({
      positionType: "firstBaseline",
      children: [{
        type: "elem",
        elem: i
  ...
  var D = R.makeSpan(["mord", "accent"], [h], e);
  return a ? (a.children[0] = D, a.height = Math.max(D.height, a.height), a.classes[0] = "mord", a) : D;
}, Pd = (n, e) => {
  var t = n.isStretchy ? Lr.mathMLnode(n.label) : new U.MathNode("mo", [T0(n.label, n.mode)]), r = new U.MathNode("mover", [Le(n.base, e), t]);
...
Z({
  ...
  mathmlBuilder: (n, e) => {
    var t = Lr.mathMLnode(n.label), r = new U.MathNode("munder", [Le(n.base, e), t]);
...
var Oa = function(e, t, r) {
  ...
  var s = R.makeSymbol(e, "Main-Regular", i, a), o = Lu(s, t, a, l);
  return r && Xd(o, a, t), o;
}, j3 = function(e, t, r, a) {
  return R.makeSymbol(e, "Size" + t + "-Regular", r, a);
}, Yd = function(e, t, r, a, i, l) {
  var s = j3(e, t, i, a), o = Lu(R.makeSpan(["delimsizing", "size" + t], [s], a), le.TEXT, a, l);
  ...
  var g = Oa(s, p, i), v = g.height + g.depth, k = Oa(u, p, i), D = k.height + k.depth, y = Oa(c, p, i), w = y.height + y.depth, E = 0, S = 1;
  if (o !== null) {
    var T = Oa(o, p, i);
    E = T.height + T.depth, S = 2;
  }
  var B = v + w + E, C = Math.max(0, Math.ceil((t - B) / (S * D))), I = B + C * S * D, N = a.fontMetrics().axisHeight;
  r && (N *= a.sizeMultiplier);
  var L = I / 2 - N, q = [];
  if (d.length > 0) {
    var Q = I - v - w, z = Math.round(I * 1e3), ue = Q5(d, Math.round(Q * 1e3)), J = new on(d, ue), De = (h / 1e3).toFixed(3) + "em", he = (z / 1e3).toFixed(3) + "em", we = new Br([J], {
      width: De,
      height: he,
      viewBox: "0 0 " + h + " " + z
    }), ye = R.makeSvgSpan([], [we], a);
    ye.height = z / 1e3, ye.style.width = De, ye.style.height = he, q.push({
      type: "elem",
      elem: ye
    });
  } else {
    if (q.push($s(c, p, i)), q.push(ji), o === null) {
      ...
      var de = (I - v - w - E) / 2 + 2 * $o;
      q.push(eo(u, de, a)), q.push(ji), q.push($s(o, p, i)), q.push(ji), q.push(eo(u, de, a));
    }
    q.push(ji), q.push($s(s, p, i));
  }
  var fe = a.havingBaseStyle(le.TEXT), Ce = R.makeVList({
    positionType: "bottom",
    positionData: L,
    children: q
  }, fe);
  return Lu(R.makeSpan(["delimsizing", "mult"], [Ce], fe), le.TEXT, a, l);
  ...
  return a.type === "small" ? (c = 1e3 + 1e3 * l + to, e < 1 ? i = 1 : e < 1.4 && (i = 0.7), o = (1 + l + ro) / i, u = (1 + l) / i, s = no("sqrtMain", o, c, l, t), s.style.minWidth = "0.853em", d = 0.833 / i) : a.type === "large" ? (c = (1e3 + to) * Ha[a.size], u = (Ha[a.size] + l) / i, o = (Ha[a.size] + l + ro) / i, s = no("sqrtSize" + a.size, o, c, l, t), s.style.minWidth = "1.02em", d = 1 / i) : (o = e + l + ro, u = e + l, c = Math.floor(1e3 * e + l) + to, s = no("sqrtTall", o, c, l, t), s.style.minWidth = "0.742em", d = 1.056), s.height = u, s.style.height = X(o), {
    span: s,
    advanceWidth: d,
...
Z({
  ...
  htmlBuilder: (n, e) => n.delim === "." ? R.makeSpan([n.mclass]) : Tr.sizedDelim(n.delim, n.size, e, n.mode, [n.mclass]),
  mathmlBuilder: (n) => {
    var e = [];
    ...
    var r = X(Tr.sizeToMaxHeight[n.size]);
...
var Nu = (n, e) => {
  var t = R.wrapFragment(Se(n.body, e), e), r = n.label.slice(1), a = e.sizeMultiplier, i, l = 0, s = ae.isCharacterBox(n.body);
  if (r === "sout")
    ...
    i = R.makeSvgSpan(["hide-tail"], [g], e), i.style.height = X(d), l = t.depth + o + u;
  } else {
  ...
  return /cancel/.test(r) && (y.height = t.height, y.depth = t.depth), /cancel/.test(r) && !s ? R.makeSpan(["mord", "cancel-lap"], [y], e) : R.makeSpan(["mord"], [y], e);
}, Ru = (n, e) => {
...
function hn(n, e, t) {
  ...
  for (w(), D.push(oc(n)); ; ) {
    ...
    if (T === "&") {
      ...
      E(), g.length === 1 && S.type === "styling" && S.body[0].body.length === 0 && (v.length > 1 || !c) && v.pop(), D.length < v.length + 1 && D.push([]);
      break;
    } else if (T === "\\\\") {
      n.consume();
      var B = void 0;
      n.gullet.future().text !== " " && (B = n.parseSizeGroup(!0)), k.push(B ? B.value : null), E(), D.push(oc(n)), g = [], v.push(g), w();
    } else
...
var mr = function(e, t) {
  ...
  for (E(l[0]), r = 0; r < e.body.length; ++r) {
    var S = e.body[r], T = D, B = y;
    s < S.length && (s = S.length);
    var C = new Array(S.length);
    for (a = 0; a < S.length; ++a) {
      var I = Se(S[a], t);
      B < I.depth && (B = I.depth), T < I.height && (T = I.height), C[a] = I;
    }
    var N = e.rowGaps[r], L = 0;
    N && (L = Ye(N, t), L > 0 && (L += y, B < L && (B = L), L = 0)), e.addJot && (B += v), C.height = T, C.depth = B, w += T, C.pos = w, w += B + L, o[r] = C, E(l[r + 1]);
  }
  var q = w / 2 + t.fontMetrics().axisHeight, Q = e.cols || [], z = [], ue, J, De = [];
  if (e.tags && e.tags.some((qt) => qt))
    for (r = 0; r < i; ++r) {
      var he = o[r], we = he.pos - q, ye = e.tags[r], ee = void 0;
      ye === !0 ? ee = R.makeSpan(["eqn-num"], [], t) : ye === !1 ? ee = R.makeSpan([], [], t) : ee = R.makeSpan([], gt(ye, t, !0), t), ee.depth = he.depth, ee.height = he.height, De.push({
        type: "elem",
        elem: ee,
        shift: we
      });
  ...
  for (
    ...
    for (var de = Q[J] || {}, fe = !0; de.type === "separator"; ) {
      if (fe || (ue = R.makeSpan(["arraycolsep"], []), ue.style.width = X(t.fontMetrics().doubleRuleSep), z.push(ue)), de.separator === "|" || de.separator === ":") {
        ...
        var j = w - q;
        j && (V.style.verticalAlign = X(-j)), z.push(V);
      } else
    ...
    if (!(a >= s)) {
      var pe = void 0;
      (a > 0 || e.hskipBeforeAndAfter) && (pe = ae.deflt(de.pregap, h), pe !== 0 && (ue = R.makeSpan(["arraycolsep"], []), ue.style.width = X(pe), z.push(ue)));
      var ke = [];
      for (r = 0; r < i; ++r) {
        var Te = o[r], Be = Te[a];
        if (Be) {
      ...
      ke = R.makeVList({
        positionType: "individualShift",
        children: ke
      }, t), ke = R.makeSpan(["col-align-" + (de.align || "c")], [ke]), z.push(ke), (a < s - 1 || e.hskipBeforeAndAfter) && (pe = ae.deflt(de.postgap, h), pe !== 0 && (ue = R.makeSpan(["arraycolsep"], []), ue.style.width = X(pe), z.push(ue)));
    }
  }
  if (o = R.makeSpan(["mtable"], z), u.length > 0) {
...
var l4 = (n, e) => {
  ...
  var p, g, v;
  t.size === le.DISPLAY.size || n.size === "display" ? (p = e.fontMetrics().num1, d > 0 ? g = 3 * h : g = 7 * h, v = e.fontMetrics().denom1) : (d > 0 ? (p = e.fontMetrics().num2, g = h) : (p = e.fontMetrics().num3, g = 3 * h), v = e.fontMetrics().denom2);
  var k;
  if (c) {
    ...
    D < g && (p += 0.5 * (g - D), v += 0.5 * (g - D)), k = R.makeVList({
      positionType: "individualShift",
      children: [{
        type: "elem",
        elem: u,
  ...
  var S, T;
  return n.leftDelim == null ? S = Ka(e, ["mopen"]) : S = Tr.customSizedDelim(n.leftDelim, E, !0, e.havingStyle(t), n.mode, ["mopen"]), n.continued ? T = R.makeSpan([]) : n.rightDelim == null ? T = Ka(e, ["mclose"]) : T = Tr.customSizedDelim(n.rightDelim, E, !0, e.havingStyle(t), n.mode, ["mclose"]), R.makeSpan(["mord"].concat(i.sizingClasses(e)), [S, R.makeSpan(["mfrac"], [k]), T], e);
}, Hu = (n, e) => {
...
var s4 = (n, e) => {
  ...
  var i = Se(a.base, e.havingBaseStyle(le.DISPLAY)), l = Lr.svgSpan(a, e), s;
...
var o4 = (n, e, t, r, a, i, l) => {
  ...
  var k = [h];
  if (o && i !== 0 && !s) {
    var D = R.makeSpan(["mspace"], [], r);
    D.style.marginRight = X(i), k.unshift(D);
  }
  return R.makeSpan(["mop", "op-limits"], k, r);
}, u4 = ["\\smallint"], ua = (n, e) => {
  var t, r, a = !1, i;
  ...
  if (i.symbol) {
    ...
    for (var g = [], v = 1; v < i.name.length; v++)
      g.push(R.mathsym(i.name[v], i.mode, e));
    o = R.makeSpan(["mop"], g, e);
  }
  var k = 0, D = 0;
  return (o instanceof x0 || i.name === "\\oiint" || i.name === "\\oiiint") && !i.suppressBaseShift && (k = (o.height - o.depth) / 2 - e.fontMetrics().axisHeight, D = o.italic), a ? o4(o, t, r, e, l, D, k) : (k && (o.style.position = "relative", o.style.top = X(k)), o);
}, ii = (n, e) => {
  var t;
  if (n.symbol)
    t = new y0("mo", [T0(n.name, n.mode)]), ae.contains(u4, n.name) && t.setAttribute("largeop", "false");
  else if (n.body)
...
Z({
  ...
  htmlBuilder(n, e) {
    ...
    if (n.index) {
      var g = e.havingStyle(le.SCRIPTSCRIPT), v = Se(n.index, g, e), k = 0.6 * (p.height - p.depth), D = R.makeVList({
        positionType: "shift",
        positionData: -k,
        children: [{
          type: "elem",
      ...
      }, e), y = R.makeSpan(["root"], [D]);
      return R.makeSpan(["mord", "sqrt"], [y, p], e);
    } else
...
Z({
  ...
  mathmlBuilder(n, e) {
    var t = pc[n.style], r = e.havingStyle(t), a = l0(n.body, r), i = new U.MathNode("mstyle", a), l = {
      display: ["0", "true"],
      text: ["0", "false"],
      script: ["1", "false"],
...
zn({
  ...
  htmlBuilder(n, e) {
    ...
    var v;
    e.style === le.DISPLAY ? v = u.sup1 : e.style.cramped ? v = u.sup3 : v = u.sup2;
    ...
    if (s && o) {
      ...
      c = Math.max(c, v, s.depth + 0.25 * u.xHeight), E = R.makeVList({
        positionType: "shift",
        positionData: -c,
        children: [{
          type: "elem",
    ...
    var N = Ko(l, "right") || "mord";
    return R.makeSpan([N], [l, R.makeSpan(["msupsub"], [E])], e);
  },
  mathmlBuilder(n, e) {
    var t = !1, r, a;
...
zn({
  ...
  mathmlBuilder(n, e) {
    var t = new U.MathNode("mi", [T0(n.text, n.mode, e)]), r = zu(n, e) || "italic";
...
zn({
  type: "tag",
  mathmlBuilder(n, e) {
    var t = new U.MathNode("mtable", [new U.MathNode("mtr", [gc(), new U.MathNode("mtd", [un(n.body, e)]), gc(), new U.MathNode("mtd", [un(n.tag, e)])])]);
...
class yc {
  ...
  lex() {
    ...
    if (r === null || r.index !== t)
      throw new G("Unexpected character: '" + e[t] + "'", new S0(e[t], new c0(this, t, t + 1)));
    var a = r[6] || r[3] || (r[2] ? "\\ " : " ");
...
var m4 = X(rr["Main-Regular"][84][1] - 0.7 * rr["Main-Regular"][65][1]);
  ...
  var t = function(r) {
    var a = /(?:^|\s)lang(?:uage)?-([\w-]+)(?=\s|$)/i, i = 0, l = {}, s = {
        ...
        insertBefore: function(y, w, E, S) {
          ...
          for (var C in T)
            if (T.hasOwnProperty(C)) {
              if (C == w)
                for (var I in E)
                  E.hasOwnProperty(I) && (B[I] = E[I]);
              E.hasOwnProperty(C) || (B[C] = T[C]);
            }
          var N = S[y];
          return S[y] = B, s.languages.DFS(s.languages, function(L, q) {
            q === N && L != y && (this[L] = B);
          }), B;
        },
        ...
        DFS: function y(w, E, S, T) {
          ...
          for (var C in w)
            if (w.hasOwnProperty(C)) {
              E.call(w, C, w[C], S || C);
              var I = w[C], N = s.util.type(I);
              N === "Object" && !T[B(I)] ? (T[B(I)] = !0, y(I, E, null, T)) : N === "Array" && !T[B(I)] && (T[B(I)] = !0, y(I, E, C, T));
            }
        }
      },
      plugins: {},
      ...
      highlightElement: function(y, w, E) {
        ...
        function N(q) {
          I.highlightedCode = q, s.hooks.run("before-insert", I), I.element.innerHTML = I.highlightedCode, s.hooks.run("after-highlight", I), s.hooks.run("complete", I), E && E.call(I.element);
        }
        if (s.hooks.run("before-sanity-check", I), B = I.element.parentElement, B && B.nodeName.toLowerCase() === "pre" && !B.hasAttribute("tabindex") && B.setAttribute("tabindex", "0"), !I.code) {
          s.hooks.run("complete", I), E && E.call(I.element);
          return;
        }
        if (s.hooks.run("before-highlight", I), !I.grammar) {
          N(s.util.encode(I.code));
          return;
        }
        if (w && r.Worker) {
          ...
          N(s.highlight(I.code, I.grammar, I.language));
      },
      /**
      ...
      for (var C in E)
        if (!(!E.hasOwnProperty(C) || !E[C])) {
          ...
          for (var N = 0; N < I.length; ++N) {
            if (B && B.cause == C + "," + N)
              return;
            var L = I[N], q = L.inside, Q = !!L.lookbehind, z = !!L.greedy, ue = L.alias;
            if (z && !L.pattern.global) {
              var J = L.pattern.toString().match(/[imsuy]*$/)[0];
              L.pattern = RegExp(L.pattern.source, J + "g");
            }
            for (var De = L.pattern || L, he = S.next, we = T; he !== w.tail && !(B && we >= B.reach); we += he.value.length, he = he.next) {
              var ye = he.value;
              ...
              if (!(ye instanceof o)) {
                var ee = 1, de;
                if (z) {
                  if (de = u(De, we, y, Q), !de || de.index >= y.length)
                    break;
                  var j = de.index, fe = de.index + de[0].length, Ce = we;
                  for (Ce += he.value.length; j >= Ce; )
                    he = he.next, Ce += he.value.length;
                  if (Ce -= he.value.length, we = Ce, he.value instanceof o)
                    continue;
                  for (var V = he; V !== w.tail && (Ce < fe || typeof V.value == "string"); V = V.next)
                    ee++, Ce += V.value.length;
                  ee--, ye = y.slice(we, Ce), de.index -= we;
                } else if (de = u(De, 0, ye, Q), !de)
                  continue;
                var j = de.index, pe = de[0], ke = ye.slice(0, j), Te = ye.slice(j + pe.length), Be = we + ye.length;
                B && Be > B.reach && (B.reach = Be);
                var Ne = he.prev;
                ke && (Ne = h(w, Ne, ke), we += ke.length), p(w, Ne, ee);
                var je = new o(C, q ? s.tokenize(pe, q) : pe, ue, pe);
      ...
      if (k.matches(d)) {
        ...
        S && S.loadLanguages(w), h(
          ...
          function(T) {
            ...
            if (B) {
              var C = T.split(/\r\n?|\n/g), I = B[0], N = B[1] == null ? C.length : B[1];
              I < 0 && (I += C.length), I = Math.max(0, Math.min(I - 1, C.length)), N < 0 && (N += C.length), N = Math.max(0, Math.min(N, C.length)), T = C.slice(I, N).join(`
...
class H4 {
  ...
  constructor(e = {}) {
    Jr.set(this, void 0), vl.set(this, void 0), bl.set(this, void 0), this.getConfiguration = () => au(bn(this, Jr, "f")), this.sanitize = (c) => {
      ...
      return x7(c, (p, g) => {
        const v = p.namespaceURI || U0.HTML, k = g.namespaceURI || U0.HTML, D = R7[v], y = O7[v], w = q7[v], E = p.tagName.toLowerCase(), S = `${w}${E}`, B = `${w}*`;
        if (!D.has(E) || !d.has(S) || v !== k && E !== y)
          g.removeChild(p);
        else {
          const C = p.getAttributeNames(), I = C.length;
          if (I) {
            for (let N = 0; N < I; N++) {
              const L = C[N], q = h[L];
              (!q || !q.has(B) && !q.has(S)) && p.removeAttribute(L);
            }
            if (b7(p))
              if (D7(p)) {
                const N = p.getAttribute("href");
                N && A7(N) && Zi(p.protocol) && p.removeAttribute("href");
...
class t8 extends W7 {
  constructor(e) {
    super(), Z7(this, e, e8, $7, J7, { margin: 0 });
  }
}
const {
  SvelteComponent: r8,
  ...
  transition_out: or,
  update_slot_base: em
} = window.__gradio__svelte__internal, { tick: i8 } = window.__gradio__svelte__internal, { onDestroy: l8 } = window.__gradio__svelte__internal, { createEventDispatcher: s8 } = window.__gradio__svelte__internal, o8 = (n) => ({}), Gc = (n) => ({}), u8 = (n) => ({}), jc = (n) => ({});
function Wc(n, e, t) {
  const r = n.slice();
...
function c8(n) {
  ...
  return {
    ...
    l(d) {
      e = lr(d, "DIV", { class: !0 });
      var h = ir(e);
      W4(t.$$.fragment, h), h.forEach(ne), r = D0(d), a = lr(d, "SPAN", { class: !0 });
      var p = ir(a);
    ...
    m(d, h) {
      ce(d, e, h), $4(t, e, null), ce(d, r, h), ce(d, a, h), kn(a, l), ce(d, s, h), c && c.m(d, h), o = !0;
    },
    p(d, h) {
      const p = {};
      h[0] & /*i18n*/
...
function f8(n) {
  ...
  return {
    ...
    m(w, E) {
      c && c.m(w, E), ce(w, e, E), ce(w, t, E), p && p.m(t, null), kn(t, r), g && g.m(t, null), ce(w, a, E), ~i && k[i].m(w, E), ce(w, s, E), y && y.m(w, E), ce(w, o, E), u = !0;
    },
    p(w, E) {
      /*variant*/
      ...
      w[5] ? g ? g.p(w, E) : (g = Jc(w), g.c(), g.m(t, null)) : g && (g.d(1), g = null), (!u || E[0] & /*variant*/
      256) && v0(
        t,
        "meta-text-center",
        /*variant*/
      ...
      let S = i;
      i = D(w), i === S ? ~i && k[i].p(w, E) : (l && (su(), or(k[S], 1, 1, () => {
        k[S] = null;
      }), lu()), ~i ? (l = k[i], l ? l.p(w, E) : (l = k[i] = v[i](w), l.c()), P0(l, 1), l.m(s.parentNode, s)) : l = null), /*timer*/
      w[5] ? y && (su(), or(y, 1, 1, () => {
        y = null;
      }), lu()) : y ? (y.p(w, E), E[0] & /*timer*/
...
function Yc(n) {
  ...
  return {
    ...
    l(r) {
      e = lr(r, "DIV", { class: !0 }), ir(e).forEach(ne), this.h();
    },
    h() {
...
function v8(n) {
  ...
  return {
    ...
    l(o) {
      ...
      t = lr(u, "DIV", { class: !0 });
      var c = ir(t);
      s && s.l(c), c.forEach(ne), r = D0(u), a = lr(u, "DIV", { class: !0 });
      var d = ir(a);
      i = lr(d, "DIV", { class: !0 }), ir(i).forEach(ne), d.forEach(ne), u.forEach(ne), this.h();
    },
    h() {
    ...
    m(o, u) {
      ce(o, e, u), kn(e, t), s && s.m(t, null), kn(e, r), kn(e, a), kn(a, i), n[31](i);
    },
    p(o, u) {
      /*progress*/
...
function af(n) {
  ...
  return {
    ...
    m(s, o) {
      ce(s, e, o), kn(e, t), ce(s, r, o), l && l.m(s, o), a = !0;
    },
    p(s, o) {
      (!a || o[0] & /*loading_text*/
      512) && F0(
...
let Ji = [], co = !1;
const k8 = typeof window < "u", tm = k8 ? window.requestAnimationFrame : (n) => {
};
function D8(n) {
  return y8(this, arguments, void 0, function* (e, t = !0) {
...
function A8(n, e, t) {
  ...
  this && this.__awaiter;
  const l = s8();
  let { i18n: s } = e, { eta: o = null } = e, { queue_position: u } = e, { queue_size: c } = e, { status: d } = e, { scroll_to_output: h = !1 } = e, { timer: p = !0 } = e, { show_progress: g = "full" } = e, { message: v = null } = e, { progress: k = null } = e, { variant: D = "default" } = e, { loading_text: y = "Loading..." } = e, { absolute: w = !0 } = e, { translucent: E = !1 } = e, { border: S = !1 } = e, { autoscroll: T } = e, B, C = !1, I = 0, N = 0, L = null, q = null, Q = 0, z = null, ue, J = null, De = !0;
  const he = () => {
    t(0, o = t(27, L = t(19, ee = null))), t(25, I = performance.now()), t(26, N = 0), C = !0, we();
  };
  function we() {
    tm(() => {
      t(26, N = (performance.now() - I) / 1e3), C && we();
    });
  }
  function ye() {
    t(26, N = 0), t(0, o = t(27, L = t(19, ee = null))), C && (C = !1);
  }
  l8(() => {
    C && ye();
  });
  ...
  function de(V) {
    Vc[V ? "unshift" : "push"](() => {
      J = V, t(16, J), t(7, k), t(14, z), t(15, ue);
    });
  }
  const fe = () => {
    l("clear_status");
  ...
  return n.$$set = (V) => {
    "i18n" in V && t(1, s = V.i18n), "eta" in V && t(0, o = V.eta), "queue_position" in V && t(2, u = V.queue_position), "queue_size" in V && t(3, c = V.queue_size), "status" in V && t(4, d = V.status), "scroll_to_output" in V && t(22, h = V.scroll_to_output), "timer" in V && t(5, p = V.timer), "show_progress" in V && t(6, g = V.show_progress), "message" in V && t(23, v = V.message), "progress" in V && t(7, k = V.progress), "variant" in V && t(8, D = V.variant), "loading_text" in V && t(9, y = V.loading_text), "absolute" in V && t(10, w = V.absolute), "translucent" in V && t(11, E = V.translucent), "border" in V && t(12, S = V.border), "autoscroll" in V && t(24, T = V.autoscroll), "$$scope" in V && t(29, i = V.$$scope);
  }, n.$$.update = () => {
    n.$$.dirty[0] & /*eta, old_eta, timer_start, eta_from_start*/
    436207617 && (o === null && t(0, o = L), o != null && L !== o && (t(28, q = (performance.now() - I) / 1e3 + o), t(19, ee = q.toFixed(1)), t(27, L = o))), n.$$.dirty[0] & /*eta_from_start, timer_diff*/
    335544320 && t(17, Q = q === null || q <= 0 || !N ? null : Math.min(N / q, 1)), n.$$.dirty[0] & /*progress*/
    128 && k != null && t(18, De = !1), n.$$.dirty[0] & /*progress, progress_level, progress_bar, last_progress_level*/
    114816 && (k != null ? t(14, z = k.map((V) => {
      if (V.index != null && V.length != null)
        return V.index / V.length;
      if (V.progress != null)
        return V.progress;
    })) : t(14, z = null), z ? (t(15, ue = z[z.length - 1]), J && (ue === 0 ? t(16, J.style.transition = "0", J) : t(16, J.style.transition = "150ms", J))) : t(15, ue = void 0)), n.$$.dirty[0] & /*status*/
    16 && (d === "pending" ? he() : ye()), n.$$.dirty[0] & /*el, scroll_to_output, status, autoscroll*/
    20979728 && B && h && (d === "pending" || d === "complete") && D8(B, T), n.$$.dirty[0] & /*status, message*/
...
const Qi = Wt(Array.prototype.forEach), C8 = Wt(Array.prototype.lastIndexOf), sf = Wt(Array.prototype.pop), Ea = Wt(Array.prototype.push), F8 = Wt(Array.prototype.splice), yl = Wt(String.prototype.toLowerCase), fo = Wt(String.prototype.toString), of = Wt(String.prototype.match), Sa = Wt(String.prototype.replace), M8 = Wt(String.prototype.indexOf), z8 = Wt(String.prototype.trim), R0 = Wt(Object.prototype.hasOwnProperty), Vt = Wt(RegExp.prototype.test), xa = B8(TypeError);
function Wt(n) {
  return function(e) {
...
function yn(n) {
  ...
  for (const [t, r] of rm(n))
    R0(n, t) && (Array.isArray(r) ? e[t] = I8(r) : r && typeof r == "object" && r.constructor === Object ? e[t] = yn(r) : e[t] = r);
  return e;
}
function Ta(n, e) {
  for (; n !== null; ) {
...
function lm() {
  let n = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : j8();
  const e = (re) => lm(re);
  ...
  })), j = null, pe = null, ke = !0, Te = !0, Be = !1, Ne = !0, je = !1, ft = !0, We = !1, qe = !1, Pe = !1, lt = !1, qt = !1, O = !1, G0 = !0, j0 = !1;
  const fa = "user-content-";
  let Y = !0, P = !1, te = {}, Fe = null;
  const Dt = be({}, ["annotation-xml", "audio", "colgroup", "desc", "foreignobject", "head", "iframe", "math", "mi", "mn", "mo", "ms", "mtext", "noembed", "noframes", "noscript", "plaintext", "script", "style", "svg", "template", "thead", "title", "video", "xmp"]);
  let Qt = null;
  const It = be({}, ["audio", "video", "img", "source", "image", "track"]);
  let $t = null;
  const gr = be({}, ["alt", "class", "for", "id", "label", "name", "pattern", "placeholder", "role", "summary", "title", "value", "style", "xmlns"]), Pt = "http://www.w3.org/1998/Math/MathML", Lt = "http://www.w3.org/2000/svg", et = "http://www.w3.org/1999/xhtml";
  let W0 = et, gs = !1, _s = null;
  const Cm = be({}, [Pt, Lt, et], fo);
  ...
  const Bm = t.createElement("form"), h1 = function(M) {
    ...
    if (!(On && On === M)) {
      ...
      Mm.indexOf(M.PARSER_MEDIA_TYPE) === -1 ? zm : M.PARSER_MEDIA_TYPE, _t = ha === "application/xhtml+xml" ? fo : yl, ee = R0(M, "ALLOWED_TAGS") ? be({}, M.ALLOWED_TAGS, _t) : de, fe = R0(M, "ALLOWED_ATTR") ? be({}, M.ALLOWED_ATTR, _t) : Ce, _s = R0(M, "ALLOWED_NAMESPACES") ? be({}, M.ALLOWED_NAMESPACES, fo) : Cm, $t = R0(M, "ADD_URI_SAFE_ATTR") ? be(yn(gr), M.ADD_URI_SAFE_ATTR, _t) : gr, Qt = R0(M, "ADD_DATA_URI_TAGS") ? be(yn(It), M.ADD_DATA_URI_TAGS, _t) : It, Fe = R0(M, "FORBID_CONTENTS") ? be({}, M.FORBID_CONTENTS, _t) : Dt, j = R0(M, "FORBID_TAGS") ? be({}, M.FORBID_TAGS, _t) : {}, pe = R0(M, "FORBID_ATTR") ? be({}, M.FORBID_ATTR, _t) : {}, te = R0(M, "USE_PROFILES") ? M.USE_PROFILES : !1, ke = M.ALLOW_ARIA_ATTR !== !1, Te = M.ALLOW_DATA_ATTR !== !1, Be = M.ALLOW_UNKNOWN_PROTOCOLS || !1, Ne = M.ALLOW_SELF_CLOSE_IN_ATTR !== !1, je = M.SAFE_FOR_TEMPLATES || !1, ft = M.SAFE_FOR_XML !== !1, We = M.WHOLE_DOCUMENT || !1, lt = M.RETURN_DOM || !1, qt = M.RETURN_DOM_FRAGMENT || !1, O = M.RETURN_TRUSTED_TYPE || !1, Pe = M.FORCE_BODY || !1, G0 = M.SANITIZE_DOM !== !1, j0 = M.SANITIZE_NAMED_PROPS || !1, Y = M.KEEP_CONTENT !== !1, P = M.IN_PLACE || !1, ye = M.ALLOWED_URI_REGEXP || am, W0 = M.NAMESPACE || et, wi = M.MATHML_TEXT_INTEGRATION_POINTS || wi, yi = M.HTML_INTEGRATION_POINTS || yi, V = M.CUSTOM_ELEMENT_HANDLING || {}, M.CUSTOM_ELEMENT_HANDLING && h1(M.CUSTOM_ELEMENT_HANDLING.tagNameCheck) && (V.tagNameCheck = M.CUSTOM_ELEMENT_HANDLING.tagNameCheck), M.CUSTOM_ELEMENT_HANDLING && h1(M.CUSTOM_ELEMENT_HANDLING.attributeNameCheck) && (V.attributeNameCheck = M.CUSTOM_ELEMENT_HANDLING.attributeNameCheck), M.CUSTOM_ELEMENT_HANDLING && typeof M.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements == "boolean" && (V.allowCustomizedBuiltInElements = M.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements), je && (Te = !1), qt && (lt = !0), te && (ee = be({}, cf), fe = [], te.html === !0 && (be(ee, uf), be(fe, ff)), te.svg === !0 && (be(ee, ho), be(fe, go), be(fe, $i)), te.svgFilters === !0 && (be(ee, mo), be(fe, go), be(fe, $i)), te.mathMl === !0 && (be(ee, po), be(fe, hf), be(fe, $i))), M.ADD_TAGS && (ee === de && (ee = yn(ee)), be(ee, M.ADD_TAGS, _t)), M.ADD_ATTR && (fe === Ce && (fe = yn(fe)), be(fe, M.ADD_ATTR, _t)), M.ADD_URI_SAFE_ATTR && be($t, M.ADD_URI_SAFE_ATTR, _t), M.FORBID_CONTENTS && (Fe === Dt && (Fe = yn(Fe)), be(Fe, M.FORBID_CONTENTS, _t)), Y && (ee["#text"] = !0), We && be(ee, ["html", "head", "body"]), ee.table && (be(ee, ["tbody"]), delete j.tbody), M.TRUSTED_TYPES_POLICY) {
        ...
        E === void 0 && (E = W8(p, a)), E !== null && typeof S == "string" && (S = E.createHTML(""));
      jt && jt(M), On = M;
    }
  }, d1 = be({}, [...ho, ...mo, ...L8]), m1 = be({}, [...po, ...N8]), Im = function(M) {
    let W = w(M);
    (!W || !W.tagName) && (W = {
      namespaceURI: W0,
      tagName: "template"
    });
    const $ = yl(M.tagName), He = yl(W.tagName);
    return _s[M.namespaceURI] ? M.namespaceURI === Lt ? W.namespaceURI === et ? $ === "svg" : W.namespaceURI === Pt ? $ === "svg" && (He === "annotation-xml" || wi[He]) : !!d1[$] : M.namespaceURI === Pt ? W.namespaceURI === et ? $ === "math" : W.namespaceURI === Lt ? $ === "math" && yi[He] : !!m1[$] : M.namespaceURI === et ? W.namespaceURI === Lt && !yi[He] || W.namespaceURI === Pt && !wi[He] ? !1 : !m1[$] && (Fm[$] || !d1[$]) : !!(ha === "application/xhtml+xml" && _s[M.namespaceURI]) : !1;
  }, X0 = function(M) {
    Ea(e.removed, {
      element: M
    });
    ...
    if (!W || !W.documentElement) {
      W = T.createDocument(W0, "template", null);
      try {
    ...
    return M && $ && Nt.insertBefore(t.createTextNode($), Nt.childNodes[0] || null), W0 === et ? I.call(W, We ? "html" : "body")[0] : We ? W.documentElement : Nt;
  }, g1 = function(M) {
    return B.call(
      M.ownerDocument || M,
      M,
  ...
  const v1 = function(M) {
    let W = null;
    if (_r(L.beforeSanitizeElements, M, null), bs(M))
      return X0(M), !0;
    const $ = _t(M.nodeName);
    if (_r(L.uponSanitizeElement, M, {
      tagName: $,
      allowedTags: ee
      ...
      return X0(M), !0;
    if (!ee[$] || j[$]) {
      if (!j[$] && w1($) && (V.tagNameCheck instanceof RegExp && Vt(V.tagNameCheck, $) || V.tagNameCheck instanceof Function && V.tagNameCheck($)))
        return !1;
      if (Y && !Fe[$]) {
    ...
    return M instanceof o && !Im(M) || ($ === "noscript" || $ === "noembed" || $ === "noframes") && Vt(/<\/no(script|embed|frames)/i, M.innerHTML) ? (X0(M), !0) : (je && M.nodeType === Ca.text && (W = M.textContent, Qi([q, Q, z], (He) => {
      W = Sa(W, He, " ");
    }), M.textContent !== W && (Ea(e.removed, {
      element: M.cloneNode()
    }), M.textContent = W)), _r(L.afterSanitizeElements, M, null), !1);
  }, b1 = function(M, W, $) {
    if (G0 && (W === "id" || W === "name") && ($ in t || $ in Bm))
      return !1;
    if (!(Te && !pe[W] && Vt(ue, W))) {
      if (!(ke && Vt(J, W))) {
        if (!fe[W] || pe[W]) {
          if (
            ...
            !(w1(M) && (V.tagNameCheck instanceof RegExp && Vt(V.tagNameCheck, M) || V.tagNameCheck instanceof Function && V.tagNameCheck(M)) && (V.attributeNameCheck instanceof RegExp && Vt(V.attributeNameCheck, W) || V.attributeNameCheck instanceof Function && V.attributeNameCheck(W)) || // Alternative, second condition checks if it's an `is`-attribute, AND
            // the value passes whatever the user has configured for CUSTOM_ELEMENT_HANDLING.tagNameCheck
            W === "is" && V.allowCustomizedBuiltInElements && (V.tagNameCheck instanceof RegExp && Vt(V.tagNameCheck, $) || V.tagNameCheck instanceof Function && V.tagNameCheck($)))
          ) return !1;
        } else if (!$t[W]) {
          if (!Vt(ye, Sa($, he, ""))) {
            if (!((W === "src" || W === "xlink:href" || W === "href") && M !== "script" && M8($, "data:") === 0 && Qt[M])) {
              if (!(Be && !Vt(De, Sa($, he, "")))) {
                if ($)
                  return !1;
              }
    ...
    _r(L.beforeSanitizeAttributes, M, null);
    const {
      attributes: W
    } = M;
    if (!W || bs(M))
    ...
    for (; He--; ) {
      ...
      let Ht = At === "value" ? Y0 : z8(Y0);
      if ($.attrName = da, $.attrValue = Ht, $.keepAttr = !0, $.forceKeepAttr = void 0, _r(L.uponSanitizeAttribute, M, $), Ht = $.attrValue, j0 && (da === "id" || da === "name") && (ki(At, M), Ht = fa + Ht), ft && Vt(/((--!?|])>)|<\/(style|title)/i, Ht)) {
        ki(At, M);
        continue;
      }
      if ($.forceKeepAttr || (ki(At, M), !$.keepAttr))
        continue;
      if (!Ne && Vt(/\/>/i, Ht)) {
        ki(At, M);
        continue;
      ...
      if (b1(k1, da, Ht)) {
        if (E && typeof p == "object" && typeof p.getAttributeType == "function" && !e0)
    ...
    _r(L.afterSanitizeAttributes, M, null);
  }, Lm = function re(M) {
    let W = null;
    const $ = g1(M);
    for (_r(L.beforeSanitizeShadowDOM, M, null); W = $.nextNode(); )
      _r(L.uponSanitizeShadowNode, W, null), v1(W), y1(W), W.content instanceof i && re(W.content);
    _r(L.afterSanitizeShadowDOM, M, null);
  };
  return e.sanitize = function(re) {
    let M = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, W = null, $ = null, He = null, Nt = null;
    ...
    if (!e.isSupported)
      return re;
    if (qe || vs(M), e.removed = [], typeof re == "string" && (P = !1), P) {
      if (re.nodeName) {
        const Y0 = _t(re.nodeName);
        if (!ee[Y0] || j[Y0])
          throw xa("root node is forbidden and cannot be sanitized in-place");
      }
    } else if (re instanceof s)
      W = p1("<!---->"), $ = W.ownerDocument.importNode(re, !0), $.nodeType === Ca.element && $.nodeName === "BODY" || $.nodeName === "HTML" ? W = $ : W.appendChild($);
    else {
      if (!lt && !je && !We && // eslint-disable-next-line unicorn/prefer-includes
      re.indexOf("<") === -1)
        return E && O ? E.createHTML(re) : re;
      if (W = p1(re), !W)
        return lt ? null : O ? S : "";
    }
    ...
    if (lt) {
      if (qt)
        for (Nt = C.call(W.ownerDocument); W.firstChild; )
          Nt.appendChild(W.firstChild);
      else
        Nt = W;
      return (fe.shadowroot || fe.shadowrootmode) && (Nt = N.call(r, Nt, !0)), Nt;
    }
    let e0 = We ? W.outerHTML : W.innerHTML;
    return We && ee["!doctype"] && W.ownerDocument && W.ownerDocument.doctype && W.ownerDocument.doctype.name && Vt(im, W.ownerDocument.doctype.name) && (e0 = "<!DOCTYPE " + W.ownerDocument.doctype.name + `>
` + e0), je && Qi([q, Q, z], (Y0) => {
      e0 = Sa(e0, Y0, " ");
    }), E && O ? E.createHTML(e0) : e0;
  }, e.setConfig = function() {
    let re = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
    vs(re), qe = !0;
  }, e.clearConfig = function() {
    On = null, qe = !1;
  }, e.isValidAttribute = function(re, M, W) {
    On || vs({});
    const $ = _t(re), He = _t(M);
    return b1($, He, W);
  }, e.addHook = function(re, M) {
    typeof M == "function" && Ea(L[re], M);
  }, e.removeHook = function(re, M) {
    if (M !== void 0) {
      const W = C8(L[re], M);
      return W === -1 ? void 0 : F8(L[re], W, 1)[0];
    }
    return sf(L[re]);
...
function vf(n) {
  ...
  return {
    ...
    l(r) {
      e = K8(r, "DIV", { class: !0 }), Z8(e).forEach(fu), this.h();
    },
    h() {
      Y8(e, "class", "streaming-bar svelte-ga0jj6"), _f(e, "animation-duration", t);
    },
    m(r, a) {
      sm(r, e, a);
    },
...
class om extends X8 {
  constructor(e) {
    super(), Q8(this, e, tp, ep, $8, { time_limit: 0 });
  }
}
const {
  SvelteComponent: rp,
...
function _p(n) {
  ...
  n[1]({}), {
    c() {
      e = yf("label"), t = yf("span"), lp(r.$$.fragment), a = dp(), i = mp(
        /*label*/
        n[0]
      ), this.h();
    },
    l(s) {
      ...
      t = wf(o, "SPAN", { class: !0 });
      var u = bf(t);
      np(r.$$.fragment, u), u.forEach(vo), a = ap(o), i = ip(
        o,
        /*label*/
        n[0]
      ), o.forEach(vo), this.h();
    ...
    m(s, o) {
      up(s, e, o), _o(e, t), cp(r, t, null), _o(e, a), _o(e, i), l = !0;
    },
    p(s, [o]) {
      (!l || o & /*label*/
      1) && hp(
...
function zp(n) {
  ...
  return u && (a = kf(u, c())), {
    c() {
      e = pu("button"), o && o.c(), t = Fp(), r = pu("div"), a && Df(a.$$.fragment), this.h();
    },
    l(d) {
      e = mu(d, "BUTTON", {
        "aria-label": !0,
      ...
      var h = du(e);
      o && o.l(h), t = Dp(h), r = mu(h, "DIV", { class: !0 });
      var p = du(r);
      a && kp(a.$$.fragment, p), p.forEach(Ga), h.forEach(Ga), this.h();
    },
    h() {
    ...
    m(d, h) {
      um(d, e, h), o && o.m(e, null), hu(e, t), hu(e, r), a && Ef(a, r, null), i = !0, l || (s = xp(
        e,
        "click",
        /*click_handler*/
        n[13]
...
const {
  ...
  append_hydration: Np,
  attr: bo,
  binding_callbacks: Rp,
  children: Cf,
  claim_element: Ff,
  create_slot: Op,
  detach: wo,
  element: Mf,
  get_all_dirty_from_scope: qp,
  get_slot_changes: Pp,
  init: Hp,
  insert_hydration: Up,
  safe_not_equal: Vp,
...
function Xp(n) {
  ...
  return {
    ...
    m(l, s) {
      Up(l, e, s), Np(e, t), i && i.m(t, null), n[6](e), r = !0;
    },
    p(l, [s]) {
      i && i.p && (!r || s & /*$$scope*/
      16) && Wp(
...
class cm extends Lp {
  constructor(e) {
    super(), Hp(this, e, Yp, Xp, Vp, { size: 0, unpadded_box: 1 });
  }
}
const Zp = /^(#\s*)(.+)$/m;
function Kp(n) {
  const e = n.trim(), t = e.match(Zp);
  if (!t)
    return [!1, e || !1];
...
function lg(n) {
  ...
  return {
    ...
    p(p, [g]) {
      let v = r;
      r = u(p), r !== v && ($p(), Ol(o[v], 1, 1, () => {
        o[v] = null;
      }), Qp(), a = o[r], a || (a = o[r] = s[r](p), a.c()), Rl(a, 1), a.m(t, null)), (!l || g & /*hovered*/
      16) && zf(
        t,
        "hovered",
        /*hovered*/
...
function sg(n, e, t) {
  ...
  return n.$$set = (h) => {
    ...
    n.$$.dirty & /*placeholder*/
    256 && t(6, [r, a] = c ? Kp(c) : [!1, !1], r, (t(5, a), t(8, c)));
  }, [i, l, s, o, u, a, r, d, c];
}
class og extends Jp {
  constructor(e) {
...
function Ug(n, e, t) {
  ...
  function y() {
    ...
    t(5, v = 1 + E * 0.15), t(4, k = E), g = requestAnimationFrame(y);
  }
  return n.$$set = (w) => {
...
function th(n) {
  ...
  return t = new oi({
    ...
    l(a) {
      e = zt(a, "DIV", { class: !0 });
      var i = Mt(e);
      dn(t.$$.fragment, i), i.forEach(xe), this.h();
    },
    h() {
...
function r9(n) {
  ...
  return {
    ...
    l(k) {
      ...
      var y = Mt(t);
      a.l(y), y.forEach(xe), i = ur(D), g && g.l(D), D.forEach(xe), l = ur(k), v && v.l(k), s = Ul(), this.h();
    },
    h() {
    ...
    d(k) {
      k && (xe(e), xe(l), xe(s)), h[r].d(), g && g.d(), v && v.d(k), u = !1, c();
    }
  };
}
function n9(n) {
  ...
  return t = new pm({}), t.$on(
    ...
    l(i) {
      ...
      var l = Mt(e);
      dn(t.$$.fragment, l), l.forEach(xe), this.h();
    },
    h() {
...
function a9(n) {
  ...
  return r = new Xl({}), {
    ...
    l(o) {
      ...
      var c = Mt(t);
      dn(r.$$.fragment, c), c.forEach(xe), a = ur(u), l = ui(u, i), u.forEach(xe), this.h();
    },
    h() {
...
function s9(n) {
  ...
  return t = new Yl({}), {
    ...
    l(l) {
      ...
      var s = Mt(e);
      dn(t.$$.fragment, s), s.forEach(xe), this.h();
    },
    h() {
...
function rh(n) {
  ...
  return {
    ...
    l(d) {
      ...
      var p = Mt(t);
      dn(r.$$.fragment, p), a = ur(p), p.forEach(xe), c.l(h), h.forEach(xe), this.h();
    },
    h() {
...
function nh(n) {
  ...
  return {
    ...
    l(s) {
      ...
      var o = Mt(e);
      r = ui(o, t), a = ur(o), o.forEach(xe), this.h();
    },
    h() {
      e.__value = i = /*device*/
...
function c9(n) {
  ...
  return s = p(n), o = h[s] = d[s](n), {
    ...
    l(g) {
      e = zt(g, "DIV", { class: !0 });
      var v = Mt(e);
      dn(t.$$.fragment, v), r = ur(v), c && c.l(v), a = ur(v), i = zt(v, "VIDEO", { class: !0 }), Mt(i).forEach(xe), l = ur(v), o.l(v), v.forEach(xe), this.h();
    },
    h() {
    ...
    d(g) {
      g && xe(e), pn(t), c && c.d(), n[31](null), h[s].d();
    }
  };
}
function e1(n, e) {
...
function f9(n, e, t) {
  var r = this && this.__awaiter || function(j, pe, ke, Te) {
    function Be(Ne) {
  ...
  let { track_constraints: E = null } = e, { rtc_configuration: S } = e, { stream_every: T = 1 } = e, { server: B } = e, { include_audio: C } = e, { i18n: I } = e;
  const N = e9();
  t9(() => document.createElement("canvas"));
  const L = (j) => r(void 0, void 0, void 0, function* () {
    const ke = j.target.value;
    yield Uf(C, a, ke, E).then((Te) => r(void 0, void 0, void 0, function* () {
      z = Te, t(10, l = i.find((Be) => Be.deviceId === ke) || null), t(14, we = !1);
    }));
  });
  function q() {
    return r(this, void 0, void 0, function* () {
      try {
        Uf(C, a, null, E).then((j) => r(this, void 0, void 0, function* () {
          t(13, ue = !0), t(9, i = yield gm()), z = j;
        })).then(() => _m(i)).then((j) => {
          t(9, i = j);
          const pe = z.getTracks().map((ke) => {
            var Te;
            return (Te = ke.getSettings()) === null || Te === void 0 ? void 0 : Te.deviceId;
          })[0];
          t(10, l = pe && j.find((ke) => ke.deviceId === pe) || i[0]);
        }), (!navigator.mediaDevices || !navigator.mediaDevices.getUserMedia) && N("error", I("image.no_webcam_support"));
      } catch (j) {
        if (j instanceof DOMException && j.name == "NotAllowedError")
          N("error", I("image.allow_webcam_access"));
        else
          throw j;
      }
    });
  ...
  function he() {
    return r(this, void 0, void 0, function* () {
      if (u === "closed") {
        ...
        }), J = new RTCPeerConnection(S), J.addEventListener("connectionstatechange", (pe) => r(this, void 0, void 0, function* () {
          switch (J.connectionState) {
            case "connected":
              t(12, u = "open"), t(11, s = o), N("tick");
              break;
            case "disconnected":
              t(12, u = "closed"), t(11, s = null), a0(J), yield q();
              break;
            case "failed":
              t(12, u = "closed"), t(11, s = null), N("error", "Connection failed!"), a0(J);
              break;
          }
        ...
        ss(z, J, h === "send" ? null : a, B.offer, De, "video", Q, p, void 0, d).then((pe) => {
          clearTimeout(j), J = pe;
        }).catch(() => {
  ...
  const fe = async () => q(), Ce = () => t(14, we = !0), V = () => t(14, we = !1);
  return n.$$set = (j) => {
    "time_limit" in j && t(22, o = j.time_limit), "on_change_cb" in j && t(23, c = j.on_change_cb), "reject_cb" in j && t(24, d = j.reject_cb), "mode" in j && t(25, h = j.mode), "rtp_params" in j && t(26, p = j.rtp_params), "icon" in j && t(0, g = j.icon), "icon_button_color" in j && t(1, v = j.icon_button_color), "icon_radius" in j && t(2, k = j.icon_radius), "pulse_color" in j && t(3, D = j.pulse_color), "button_labels" in j && t(4, y = j.button_labels), "track_constraints" in j && t(28, E = j.track_constraints), "rtc_configuration" in j && t(20, S = j.rtc_configuration), "stream_every" in j && t(29, T = j.stream_every), "server" in j && t(30, B = j.server), "include_audio" in j && t(5, C = j.include_audio), "i18n" in j && t(6, I = j.i18n), "webrtc_id" in j && t(21, De = j.webrtc_id);
  }, [
    g,
    v,
    k,
...
function x9(n, e, t) {
  ...
  } } = e, { stream_handler: c } = e, { time_limit: d = null } = e, { button_labels: h } = e, { server: p } = e, { rtc_configuration: g } = e, { track_constraints: v = {} } = e, { mode: k } = e, { on_change_cb: D } = e, { reject_cb: y } = e, { rtp_params: w = {} } = e, { icon: E = void 0 } = e, { icon_button_color: S = "var(--color-accent)" } = e, { pulse_color: T = "var(--color-accent)" } = e, { icon_radius: B = 50 } = e;
  const C = A9();
  function I(z) {
    r = z, t(0, r);
  }
  ...
  return n.$$set = (z) => {
    "value" in z && t(0, r = z.value), "label" in z && t(1, a = z.label), "show_label" in z && t(2, i = z.show_label), "include_audio" in z && t(3, l = z.include_audio), "i18n" in z && t(4, s = z.i18n), "active_source" in z && t(18, o = z.active_source), "handle_reset_value" in z && t(19, u = z.handle_reset_value), "stream_handler" in z && t(20, c = z.stream_handler), "time_limit" in z && t(5, d = z.time_limit), "button_labels" in z && t(6, h = z.button_labels), "server" in z && t(7, p = z.server), "rtc_configuration" in z && t(8, g = z.rtc_configuration), "track_constraints" in z && t(9, v = z.track_constraints), "mode" in z && t(10, k = z.mode), "on_change_cb" in z && t(11, D = z.on_change_cb), "reject_cb" in z && t(12, y = z.reject_cb), "rtp_params" in z && t(13, w = z.rtp_params), "icon" in z && t(14, E = z.icon), "icon_button_color" in z && t(15, S = z.icon_button_color), "pulse_color" in z && t(16, T = z.pulse_color), "icon_radius" in z && t(17, B = z.icon_radius);
  }, C("drag", S9), [
    r,
    a,
    i,
...
function R9(n, e, t) {
  var r = this && this.__awaiter || function(d, h, p, g) {
    ...
    return new (p || (p = Promise))(function(k, D) {
      ...
      function E(S) {
        S.done ? k(S.value) : v(S.value).then(y, w);
      }
...
function Z9(n, e, t) {
  var r = this && this.__awaiter || function(D, y, w, E) {
    ...
    return new (w || (w = Promise))(function(T, B) {
      ...
      function N(L) {
        L.done ? T(L.value) : S(L.value).then(C, I);
      }
      N((E = E.apply(D, y || [])).next());
    });
  };
...
function D_(n, e, t) {
  var r = this && this.__awaiter || function(L, q, Q, z) {
    function ue(J) {
      return J instanceof Q ? J : new Q(function(De) {
        De(J);
      });
    }
    return new (Q || (Q = Promise))(function(J, De) {
      function he(ee) {
        try {
          ye(z.next(ee));
        } catch (de) {
      ...
      function ye(ee) {
        ee.done ? J(ee.value) : ue(ee.value).then(he, we);
      }
      ye((z = z.apply(L, q || [])).next());
    });
  };
  let { value: a = null } = e, { label: i = void 0 } = e, { show_label: l = !0 } = e, { rtc_configuration: s = null } = e, { i18n: o } = e, { on_change_cb: u } = e, { icon: c = void 0 } = e, { icon_button_color: d = "var(--color-accent)" } = e, { pulse_color: h = "var(--color-accent)" } = e, { icon_radius: p = 50 } = e, { server: g } = e, v = "closed", k, D, y = Math.random().toString(36).substring(2), w = (L) => {
    L.type === "end_stream" ? (u(L), t(8, v = "closed"), a0(D)) : (console.debug("calling on_change_cb with msg", L), u(L));
  };
  const E = w_();
  function S(L) {
    return r(this, void 0, void 0, function* () {
      if (L === "start_webrtc_stream") {
        t(8, v = "waiting"), y = Math.random().toString(36).substring(2), L = y, D = new RTCPeerConnection(s), D.addEventListener("connectionstatechange", (z) => r(this, void 0, void 0, function* () {
          switch (D.connectionState) {
            case "connected":
              console.info("connected"), t(8, v = "open"), E("tick");
              break;
            case "disconnected":
              console.info("closed"), a0(D);
              break;
            case "failed":
              t(8, v = "closed"), E("error", "Connection failed!"), a0(D);
              break;
          }
        }));
        let q = null;
        ...
        ss(q, D, k, g.offer, y, "audio", w).then((z) => {
          clearTimeout(Q), D = z;
        }).catch(() => {
          clearTimeout(Q), console.info("catching"), E("error", "Too many concurrent users. Come back later!");
        });
      }
      return L;
    });
  ...
  const C = () => E("stop"), I = () => E("play"), N = () => k.srcObject;
  return n.$$set = (L) => {
    "value" in L && t(0, a = L.value), "label" in L && t(1, i = L.label), "show_label" in L && t(2, l = L.show_label), "rtc_configuration" in L && t(11, s = L.rtc_configuration), "i18n" in L && t(3, o = L.i18n), "on_change_cb" in L && t(12, u = L.on_change_cb), "icon" in L && t(4, c = L.icon), "icon_button_color" in L && t(5, d = L.icon_button_color), "pulse_color" in L && t(6, h = L.pulse_color), "icon_radius" in L && t(7, p = L.icon_radius), "server" in L && t(13, g = L.server);
  }, n.$$.update = () => {
    n.$$.dirty & /*value*/
    1 && S(a).then((L) => {
      t(0, a = L);
...
function nv(n, e, t) {
  var r = this && this.__awaiter || function(S, T, B, C) {
    function I(N) {
      return N instanceof B ? N : new B(function(L) {
        L(N);
      });
    }
    return new (B || (B = Promise))(function(N, L) {
      function q(ue) {
        try {
          z(C.next(ue));
        } catch (J) {
      ...
      function z(ue) {
        ue.done ? N(ue.value) : I(ue.value).then(q, Q);
      }
      z((C = C.apply(S, T || [])).next());
    });
  };
  ...
  function D(S, T) {
    if (T === !0) {
      ...
      return S.replace(B, (C, I, N) => U_.includes(I.toLowerCase()) ? C : C.replace(/</g, "&lt;").replace(/>/g, "&gt;"));
    }
    if (Array.isArray(T)) {
      const B = T.map((I) => ({
      ...
      let C = S;
      return B.forEach((I) => {
        C = C.replace(I.open, (N) => N.replace(/</g, "&lt;").replace(/>/g, "&gt;")), C = C.replace(I.close, (N) => N.replace(/</g, "&lt;").replace(/>/g, "&gt;"));
      }), C;
    }
    return S;
  }
  function y(S) {
    ...
    if (o) {
      const B = [];
      s.forEach((C, I) => {
        const N = Vh(C.left), L = Vh(C.right), q = new RegExp(`${N}([\\s\\S]+?)${L}`, "g");
        T = T.replace(q, (Q, z) => (B.push(Q), `%%%LATEX_BLOCK_${B.length - 1}%%%`));
      }), T = k.parse(T), T = T.replace(/%%%LATEX_BLOCK_(\d+)%%%/g, (C, I) => B[parseInt(I, 10)]);
    }
    return h && (T = D(T, h)), l && Nc && (T = Nc(T, d)), T;
  }
  function w(S) {
    return r(this, void 0, void 0, function* () {
      if (s.length > 0 && S && s.some((B) => S.includes(B.left) && S.includes(B.right)) && T6(g, {
        delimiters: s,
        throwOnError: !1
      }), g) {
        ...
        if (T.length > 0) {
          yield tv();
          const { default: B } = yield import("./mermaid.core-CcN5g6fs.js").then((C) => C.by);
          B.initialize({
            startOnLoad: !1,
...
function ad(n) {
  ...
  return t = u(n), r = o[t] = s[t](n), {
    ...
    h() {
      se(e, "class", "submit-button svelte-bj4kw9"), Cr(
        e,
        "padded-button",
        /*submit_btn*/
        n[10] !== !0
...
function id(n) {
  ...
  return t = u(n), r = o[t] = s[t](n), {
    ...
    h() {
      se(e, "class", "stop-button svelte-bj4kw9"), Cr(
        e,
        "padded-button",
        /*stop_btn*/
        n[11] !== !0
...
function qb(n) {
  ...
  return {
    ...
    h() {
      se(i, "class", "input-container svelte-bj4kw9"), se(e, "class", "svelte-bj4kw9"), Cr(
        e,
        "container",
        /*container*/
        n[7]
...
function Pb(n, e, t) {
  var r = this && this.__awaiter || function(P, te, Fe, Dt) {
    function Qt(It) {
    ...
    return new (Fe || (Fe = Promise))(function(It, $t) {
      ...
      Lt((Dt = Dt.apply(P, te || [])).next());
    });
  };
  let { value: a = "" } = e, { value_is_output: i = !1 } = e, { lines: l = 1 } = e, { placeholder: s = "Type here..." } = e, { label: o } = e, { info: u = void 0 } = e, { disabled: c = !1 } = e, { show_label: d = !0 } = e, { container: h = !0 } = e, { max_lines: p = void 0 } = e, { type: g = "text" } = e, { show_copy_button: v = !1 } = e, { submit_btn: k = null } = e, { stop_btn: D = null } = e, { rtl: y = !1 } = e, { autofocus: w = !1 } = e, { text_align: E = void 0 } = e, { autoscroll: S = !0 } = e, { max_length: T = void 0 } = e, { root: B } = e, C, I = !1, N, L, q = 0, Q = !1, z;
  const ue = !k, J = Sb();
  Ab(() => {
    L = C && C.offsetHeight + C.scrollTop > C.scrollHeight - 100;
  });
  const De = () => {
    L && S && !Q && C.scrollTo(0, C.scrollHeight);
  };
  function he() {
    J("change", a), i || J("input");
  }
  Eb(() => {
    w && C.focus(), L && S && De(), t(28, i = !1);
  });
  function we() {
    return r(this, void 0, void 0, function* () {
      "clipboard" in navigator && (yield navigator.clipboard.writeText(a), J("copy", { value: a }), ye());
    });
  }
  function ye() {
    t(19, I = !0), N && clearTimeout(N), N = setTimeout(
      () => {
        t(19, I = !1);
      },
      1e3
  ...
  function ee(P) {
    const te = P.target, Fe = te.value, Dt = [te.selectionStart, te.selectionEnd];
    J("select", { value: Fe.substring(...Dt), index: Dt });
  }
  function de(P) {
    return r(this, void 0, void 0, function* () {
      yield rd(), (P.key === "Enter" && P.shiftKey && l > 1 || P.key === "Enter" && !P.shiftKey && l === 1 && z >= 1) && (P.preventDefault(), J("submit"));
    });
  }
  function fe(P) {
    const te = P.target, Fe = te.scrollTop;
    Fe < q && (Q = !0), q = Fe;
    const Dt = te.scrollHeight - te.clientHeight;
    Fe >= Dt && (Q = !1);
  }
  function Ce() {
    J("stop");
  ...
  function j(P) {
    return r(this, void 0, void 0, function* () {
      if (yield rd(), l === z) return;
      const te = P.target, Fe = window.getComputedStyle(te), Dt = parseFloat(Fe.paddingTop), Qt = parseFloat(Fe.paddingBottom), It = parseFloat(Fe.lineHeight);
      let $t = z === void 0 ? !1 : Dt + Qt + It * z, gr = Dt + Qt + l * It;
      te.style.height = "1px";
      let Pt;
      $t && te.scrollHeight > $t ? Pt = $t : te.scrollHeight < gr ? Pt = gr : Pt = te.scrollHeight, te.style.height = `${Pt}px`;
    });
  }
  function pe(P, te) {
    if (l !== z && (P.style.overflowY = "scroll", P.addEventListener("input", j), !!te.trim()))
      return j({ target: P }), {
...
function Jb(n) {
  ...
  return e = new oi({
    ...
    p(r, a) {
      ...
      r[3]), a & /*is_mic_muted*/
      8192 && (i.icon = /*is_mic_muted*/
      r[13] ? bu : Tn), a & /*icon_button_color*/
...
function sd(n) {
  ...
  return r = h(n), a = d[r] = c[r](n), {
    ...
    h() {
      ...
      n[7]}; stroke: ${/*icon_button_color*/
      n[7]}; color: ${/*icon_button_color*/
      n[7]};`), dt(e, "class", "button svelte-1j1z049"), dt(e, "aria-label", l = /*is_muted*/
      n[12] ? "unmute audio" : "mute audio"), Ya(
        e,
        "hidden",
        /*stream_state*/
        n[9] === "closed"
    ...
    p(p, g) {
      ...
      n[7]}; stroke: ${/*icon_button_color*/
      n[7]}; color: ${/*icon_button_color*/
      n[7]};`)) && dt(t, "style", i), (!s || g & /*is_muted*/
      4096 && l !== (l = /*is_muted*/
      n[12] ? "unmute audio" : "mute audio")) && dt(e, "aria-label", l), (!s || g & /*stream_state*/
      512) && Ya(
        e,
        "hidden",
        /*stream_state*/
...
function ew(n) {
  ...
  return e = new oi({
    ...
    p(r, a) {
      ...
      r[2]), a & /*is_muted*/
      4096 && (i.icon = /*is_muted*/
      r[12] ? Sl : El), a & /*icon_button_color*/
      128 && (i.icon_button_color = /*icon_button_color*/
      r[7]), a & /*pulse_color*/
      256 && (i.pulse_color = /*pulse_color*/
      r[8]), e.$set(i);
...
function tw(n) {
  ...
  let N = (
    /*mode*/
    n[10] === "send-receive" && sd(n)
  );
  return v = new Dd({ props: { fill: "none" } }), {
    c() {
      e = rn("div"), Rr(t.$$.fragment), a = pl(), T && T.c(), i = pl(), l = rn("button"), s = rn("div"), u.c(), d = pl(), N && N.c(), h = pl(), p = rn("button"), g = rn("div"), Rr(v.$$.fragment), this.h();
    },
    l(L) {
      e = tn(L, "DIV", { class: !0 });
      var q = en(e);
      ...
      var Q = en(l);
      s = tn(Q, "DIV", { class: !0, style: !0 });
      var z = en(s);
      u.l(z), z.forEach(q0), Q.forEach(q0), d = ml(q), N && N.l(q), h = ml(q), p = tn(q, "BUTTON", { class: !0, "aria-label": !0 });
      var ue = en(p);
      g = tn(ue, "DIV", { class: !0, style: !0 });
      var J = en(g);
      Nr(v.$$.fragment, J), J.forEach(q0), ue.forEach(q0), q.forEach(q0), this.h();
    },
    h() {
      dt(s, "class", "icon"), dt(s, "style", c = `fill: ${/*icon_button_color*/
      n[7]}; stroke: ${/*icon_button_color*/
      n[7]}; color: ${/*icon_button_color*/
      n[7]};`), dt(l, "class", "button svelte-1j1z049"), Ya(l, "padded-button", !1), dt(g, "class", "icon"), dt(g, "style", k = `fill: ${/*icon_button_color*/
      n[7]}; stroke: ${/*icon_button_color*/
      n[7]}; color: ${/*icon_button_color*/
      n[7]};`), dt(p, "class", "button svelte-1j1z049"), dt(p, "aria-label", "stop stream"), Ya(
        p,
        "hidden",
        /*stream_state*/
        n[9] === "closed"
    ...
    m(L, q) {
      u1(L, e, q), qr(t, e, null), yr(e, a), T && T.m(e, null), yr(e, i), yr(e, l), yr(l, s), C[o].m(s, null), yr(e, d), N && N.m(e, null), yr(e, h), yr(e, p), yr(p, g), qr(v, g, null), D = !0, y || (w = [
        wu(
          l,
          "click",
          /*click_mic_icon*/
    ...
    p(L, q) {
      const Q = {};
      q & /*pending*/
      2048 && (Q.submit_btn = !/*pending*/
      L[11]), q & /*pending*/
      2048 && (Q.disabled = /*pending*/
      L[11]), !r && q & /*value*/
      1 && (r = !0, Q.value = /*value*/
      L[0].textbox, Vb(() => r = !1)), t.$set(Q), /*pending*/
      L[11] ? T ? (T.p(L, q), q & /*pending*/
      2048 && mt(T, 1)) : (T = ld(L), T.c(), mt(T, 1), T.m(e, i)) : T && (Al(), Tt(T, 1, 1, () => {
        T = null;
      }), Dl());
      let z = o;
      o = I(L), o === z ? C[o].p(L, q) : (Al(), Tt(C[z], 1, 1, () => {
        C[z] = null;
      }), Dl(), u = C[o], u ? u.p(L, q) : (u = C[o] = B[o](L), u.c()), mt(u, 1), u.m(s, null)), (!D || q & /*icon_button_color*/
      128 && c !== (c = `fill: ${/*icon_button_color*/
      L[7]}; stroke: ${/*icon_button_color*/
      L[7]}; color: ${/*icon_button_color*/
      L[7]};`)) && dt(s, "style", c), /*mode*/
      L[10] === "send-receive" ? N ? (N.p(L, q), q & /*mode*/
      1024 && mt(N, 1)) : (N = sd(L), N.c(), mt(N, 1), N.m(e, h)) : N && (Al(), Tt(N, 1, 1, () => {
        N = null;
      }), Dl()), (!D || q & /*icon_button_color*/
      128 && k !== (k = `fill: ${/*icon_button_color*/
      L[7]}; stroke: ${/*icon_button_color*/
      L[7]}; color: ${/*icon_button_color*/
      L[7]};`)) && dt(g, "style", k), (!D || q & /*stream_state*/
      512) && Ya(
        p,
        "hidden",
        /*stream_state*/
    ...
    i(L) {
      D || (mt(t.$$.fragment, L), mt(T), mt(u), mt(N), mt(v.$$.fragment, L), D = !0);
    },
    o(L) {
      Tt(t.$$.fragment, L), Tt(T), Tt(u), Tt(N), Tt(v.$$.fragment, L), D = !1;
    },
    d(L) {
      L && q0(e), Or(t), T && T.d(), C[o].d(), N && N.d(), Or(v), y = !1, Yb(w);
    }
  };
}
function rw(n) {
  ...
  return e = new kd({
    ...
    p(r, [a]) {
      const i = {};
      a & /*$$scope, stream_state, icon_button_color, is_muted, toggleMute, audio_source_callback, pulse_color, mode, input_audio_source_callback, is_mic_muted, pending, value, start_stream, on_change_cb, trigger_response*/
      134234111 && (i.$$scope = { dirty: a, ctx: r }), e.$set(i);
    },
    i(r) {
      t || (mt(e.$$.fragment, r), t = !0);
    },
...
function nw(n, e, t) {
  let { value: r = null } = e, { rtc_configuration: a = null } = e, { time_limit: i = null } = e, { track_constraints: l = {} } = e, { access_mic: s } = e, { start_stream: o } = e, { audio_source_callback: u } = e, { input_audio_source_callback: c } = e, { toggleMuteMicrophone: d } = e, { handle_click_outside: h } = e, { handle_device_change: p } = e, { toggleMute: g } = e, { on_change_cb: v } = e, { trigger_response: k } = e, { icon: D = void 0 } = e, { icon_button_color: y = "var(--color-accent)" } = e, { pulse_color: w = "var(--color-accent)" } = e, { stream_state: E = "closed" } = e, { mode: S = "send-receive" } = e, { pending: T = !1 } = e, { mic_accessed: B = !1 } = e, { is_muted: C = !1 } = e, { is_mic_muted: I = !1 } = e;
  function N() {
    E === "open" ? d() : (s(), o());
  }
  function L() {
  ...
  function q(z) {
    n.$$.not_equal(r.textbox, z) && (r.textbox = z, t(0, r));
  }
  const Q = async () => {
    if (E === "closed")
      for (await o(); E !== "open"; )
        await new Promise((z) => setTimeout(z, 100));
    v({ type: "send_input" }), console.log("called tick"), await k({
      webrtc_id: r.webrtc_id,
      args: [r]
    }), t(0, r.textbox = "", r);
  };
  return n.$$set = (z) => {
    "value" in z && t(0, r = z.value), "rtc_configuration" in z && t(16, a = z.rtc_configuration), "time_limit" in z && t(17, i = z.time_limit), "track_constraints" in z && t(18, l = z.track_constraints), "access_mic" in z && t(19, s = z.access_mic), "start_stream" in z && t(1, o = z.start_stream), "audio_source_callback" in z && t(2, u = z.audio_source_callback), "input_audio_source_callback" in z && t(3, c = z.input_audio_source_callback), "toggleMuteMicrophone" in z && t(20, d = z.toggleMuteMicrophone), "handle_click_outside" in z && t(21, h = z.handle_click_outside), "handle_device_change" in z && t(22, p = z.handle_device_change), "toggleMute" in z && t(4, g = z.toggleMute), "on_change_cb" in z && t(5, v = z.on_change_cb), "trigger_response" in z && t(6, k = z.trigger_response), "icon" in z && t(23, D = z.icon), "icon_button_color" in z && t(7, y = z.icon_button_color), "pulse_color" in z && t(8, w = z.pulse_color), "stream_state" in z && t(9, E = z.stream_state), "mode" in z && t(10, S = z.mode), "pending" in z && t(11, T = z.pending), "mic_accessed" in z && t(24, B = z.mic_accessed), "is_muted" in z && t(12, C = z.is_muted), "is_mic_muted" in z && t(13, I = z.is_mic_muted);
  }, n.$$.update = () => {
    n.$$.dirty & /*value*/
...
class aw extends Ub {
  constructor(e) {
    super(), Wb(this, e, nw, rw, Zb, {
      ...
      time_limit: 17,
      track_constraints: 18,
      access_mic: 19,
      start_stream: 1,
      audio_source_callback: 2,
      input_audio_source_callback: 3,
      toggleMuteMicrophone: 20,
      handle_click_outside: 21,
      handle_device_change: 22,
      toggleMute: 4,
      on_change_cb: 5,
      trigger_response: 6,
      icon: 23,
...
function _w(n) {
  ...
  return {
    c() {
      Yt(e.$$.fragment), t = d0(), Yt(r.$$.fragment), a = d0(), i = it("div"), l = it("button"), o.c(), u = d0(), E && E.c(), c = d0(), S && S.c(), d = d0(), T && T.c(), p = d0(), B && B.c(), this.h();
    },
    l(C) {
      Xt(e.$$.fragment, C), t = h0(C), Xt(r.$$.fragment, C), a = h0(C), i = at(C, "DIV", { class: !0 });
      var I = nt(i);
      l = at(I, "BUTTON", { "aria-label": !0, class: !0 });
      var N = nt(l);
      o.l(N), N.forEach(_e), u = h0(I), E && E.l(I), c = h0(I), S && S.l(I), d = h0(I), T && T.l(I), p = h0(I), B && B.l(I), I.forEach(_e), this.h();
    },
    h() {
    ...
    m(C, I) {
      Kt(e, C, I), kt(C, t, I), Kt(r, C, I), kt(C, a, I), kt(C, i, I), $e(i, l), y[s].m(l, null), $e(i, u), E && E.m(i, null), $e(i, c), S && S.m(i, null), $e(i, d), T && T.m(i, null), $e(i, p), B && B.m(i, null), g = !0, v || (k = Fr(
        l,
        "click",
        /*start_stream*/
        n[29]
    ...
    p(C, I) {
      const N = {};
      I[0] & /*stream_state*/
      524288 && (N.stream_state = /*stream_state*/
      C[19]), I[0] & /*icon*/
      256 && (N.icon = /*icon*/
      C[8]), I[0] & /*icon_button_color*/
      512 && (N.icon_button_color = /*icon_button_color*/
      C[9]), I[0] & /*pulse_color*/
      1024 && (N.pulse_color = /*pulse_color*/
      C[10]), I[0] & /*pending*/
      65536 && (N.pending = /*pending*/
      C[16]), I[0] & /*icon_radius*/
      2048 && (N.icon_radius = /*icon_radius*/
      C[11]), e.$set(N);
      const L = {};
      I[0] & /*_time_limit*/
      262144 && (L.time_limit = /*_time_limit*/
      C[18]), r.$set(L);
      let q = s;
      s = w(C), s === q ? y[s].p(C, I) : (tr(), Ae(y[q], 1, 1, () => {
        y[q] = null;
      }), er(), o = y[s], o ? o.p(C, I) : (o = y[s] = D[s](C), o.c()), ge(o, 1), o.m(l, null)), /*stream_state*/
      C[19] === "closed" ? E ? (E.p(C, I), I[0] & /*stream_state*/
      524288 && ge(E, 1)) : (E = hd(C), E.c(), ge(E, 1), E.m(i, c)) : E && (tr(), Ae(E, 1, 1, () => {
        E = null;
      }), er()), /*stream_state*/
      C[19] === "open" && /*mode*/
      C[2] === "send-receive" ? S ? (S.p(C, I), I[0] & /*stream_state, mode*/
      524292 && ge(S, 1)) : (S = dd(C), S.c(), ge(S, 1), S.m(i, d)) : S && (tr(), Ae(S, 1, 1, () => {
        S = null;
      }), er()), I[0] & /*stream_state, mode*/
      524292 && (h = /*stream_state*/
      C[19] === "open" && /*mode*/
      C[2].includes("send")), h ? T ? (T.p(C, I), I[0] & /*stream_state, mode*/
      524292 && ge(T, 1)) : (T = md(C), T.c(), ge(T, 1), T.m(i, p)) : T && (tr(), Ae(T, 1, 1, () => {
        T = null;
      }), er()), /*options_open*/
      C[17] && /*selected_device*/
      C[22] ? B ? (B.p(C, I), I[0] & /*options_open, selected_device*/
      4325376 && ge(B, 1)) : (B = pd(C), B.c(), ge(B, 1), B.m(i, null)) : B && (tr(), Ae(B, 1, 1, () => {
        B = null;
      }), er()), (!g || I[0] & /*stopword_recognized*/
      32768) && ku(
        i,
        "pulse",
        /*stopword_recognized*/
    ...
    i(C) {
      g || (ge(e.$$.fragment, C), ge(r.$$.fragment, C), ge(o), ge(E), ge(S), ge(T), ge(B), g = !0);
    },
    o(C) {
      Ae(e.$$.fragment, C), Ae(r.$$.fragment, C), Ae(o), Ae(E), Ae(S), Ae(T), Ae(B), g = !1;
    },
    d(C) {
      C && (_e(t), _e(a), _e(i)), Zt(e, C), Zt(r, C), y[s].d(), E && E.d(), S && S.d(), T && T.d(), B && B.d(), v = !1, k();
    }
  };
}
function vw(n) {
  ...
  return t = new pm({ props: { icon: Tn } }), t.$on(
    ...
    l(i) {
      ...
      var l = nt(e);
      Xt(t.$$.fragment, l), l.forEach(_e), this.h();
    },
    h() {
...
function ww(n) {
  ...
  return r = new Xl({}), {
    ...
    l(o) {
      ...
      var c = nt(t);
      Xt(r.$$.fragment, c), c.forEach(_e), a = h0(u), l = _i(u, i), u.forEach(_e), this.h();
    },
    h() {
  ...
  return t = c(n), r = u[t] = o[t](n), {
    ...
    p(d, h) {
      ...
      t = c(d), t === p ? u[t].p(d, h) : (tr(), Ae(u[p], 1, 1, () => {
        u[p] = null;
      }), er(), r = u[t], r ? r.p(d, h) : (r = u[t] = o[t](d), r.c()), ge(r, 1), r.m(e, a)), (!s || h[0] & /*button_labels, i18n*/
      4128) && i !== (i = /*button_labels*/
      (d[12].stop || /*i18n*/
...
function Dw(n) {
  ...
  return t = new Xl({}), {
    ...
    l(a) {
      ...
      var i = nt(e);
      Xt(t.$$.fragment, i), i.forEach(_e), this.h();
    },
    h() {
...
function hd(n) {
  ...
  return t = new Yl({}), {
    ...
    l(l) {
      ...
      var s = nt(e);
      Xt(t.$$.fragment, s), s.forEach(_e), this.h();
    },
    h() {
...
function dd(n) {
  ...
  return r = h(n), a = d[r] = c[r](n), {
    ...
    l(p) {
      ...
      var v = nt(t);
      a.l(v), v.forEach(_e), g.forEach(_e), this.h();
    },
    h() {
    ...
    p(p, g) {
      ...
      r = h(p), r !== v && (tr(), Ae(d[v], 1, 1, () => {
        d[v] = null;
      }), er(), a = d[r], a || (a = d[r] = c[r](p), a.c()), ge(a, 1), a.m(t, null)), (!s || g[0] & /*icon_button_color*/
...
function pd(n) {
  ...
  return {
    ...
    l(d) {
      ...
      var p = nt(t);
      Xt(r.$$.fragment, p), a = h0(p), p.forEach(_e), c.l(h), h.forEach(_e), this.h();
    },
    h() {
...
function Mw(n) {
  ...
  return i = p(n), l = h[i] = d[i](n), {
    ...
    l(g) {
      ...
      var v = nt(t);
      r = at(v, "AUDIO", { class: !0 }), nt(r).forEach(_e), a = h0(v), l.l(v), v.forEach(_e), this.h();
    },
    h() {
    ...
    p(g, v) {
      ...
      8192 && ge(c, 1)) : (c = fd(g), c.c(), ge(c, 1), c.m(e.parentNode, e)) : c && (tr(), Ae(c, 1, 1, () => {
        c = null;
      }), er());
      let k = i;
      i = p(g), i === k ? h[i].p(g, v) : (tr(), Ae(h[k], 1, 1, () => {
        h[k] = null;
      }), er(), l = h[i], l ? l.p(g, v) : (l = h[i] = d[i](g), l.c()), ge(l, 1), l.m(t, null));
    },
    i(g) {
      s || (ge(c), ge(l), s = !0);
    },
    ...
    d(g) {
      g && (_e(e), _e(t)), c && c.d(g), n[40](null), h[i].d(), o = !1, Tm(u);
    }
  };
}
function zw(n, e) {
...
function Bw(n, e, t) {
  var r = this && this.__awaiter || function(Y, P, te, Fe) {
    function Dt(Qt) {
      return Qt instanceof te ? Qt : new te(function(It) {
        It(Qt);
      });
    }
    return new (te || (te = Promise))(function(Qt, It) {
      function $t(Lt) {
        try {
          Pt(Fe.next(Lt));
        } catch (et) {
  ...
  let C = (Y) => {
    Y === "stopword" ? (t(15, T = !0), setTimeout(
      ...
      3e3
    )) : Y.type === "end_stream" ? (t(19, q = "closed"), a0(z), p(Y)) : (console.debug("calling on_change_cb with msg", Y), p(Y));
  }, I = !1, N = null, { server: L } = e, q = "closed", Q, z, ue = null, J, De, he = null, we = !1, ye = !1, ee = !1;
  const de = () => a === "send" ? J : Q.srcObject, fe = pw();
  function Ce() {
    return r(this, void 0, void 0, function* () {
      try {
        const P = he ? Object.assign(
          {
      ...
      t(21, De = _m(yield gm(), "audioinput")), t(23, we = !0);
      const Y = J.getTracks().map((P) => {
        var te;
        return (te = P.getSettings()) === null || te === void 0 ? void 0 : te.deviceId;
      })[0];
      t(22, he = Y && De.find((P) => P.deviceId === Y) || De[0]);
    });
  }
  function V() {
    return r(this, void 0, void 0, function* () {
      if (q === "open") {
        a0(z), t(19, q = "closed"), t(18, N = null), yield Ce();
        return;
      }
      ue = Math.random().toString(36).substring(2), t(0, i.webrtc_id = ue, i), t(19, q = "waiting"), yield L.turn().then((te) => {
        if (te.error) {
          fe("error", te.error);
          return;
        }
        t(1, o = te), console.info("rtc_configuration", te);
      }), z = new RTCPeerConnection(o), console.info("created"), z.addEventListener("connectionstatechange", (te) => r(this, void 0, void 0, function* () {
        switch (z.connectionState) {
          case "connected":
            console.info("connected"), t(19, q = "open"), t(18, N = c);
            break;
          case "disconnected":
            console.info("closed"), t(19, q = "closed"), t(18, N = null), a0(z);
            break;
          case "failed":
            console.info("failed"), t(19, q = "closed"), t(18, N = null), fe("error", "Connection failed!"), a0(z);
            break;
        }
      })), J = null;
      try {
      ...
      ss(J, z, a === "send" ? null : Q, L.offer, ue, "audio", C, h, Y, g).then((te) => {
        clearTimeout(P), z = te;
      }).catch(() => {
  ...
  function j(Y) {
    Y.preventDefault(), Y.stopPropagation(), t(17, I = !1);
  }
  const pe = (Y) => r(void 0, void 0, void 0, function* () {
    const te = Y.target.value;
    J = yield navigator.mediaDevices.getUserMedia({
      audio: Object.assign({ deviceId: { exact: te } }, d)
    }), t(22, he = De.find((Fe) => Fe.deviceId === te) || null), t(17, I = !1);
  });
  function ke() {
    Q && (t(20, Q.muted = !Q.muted, Q), t(24, ye = Q.muted));
  }
  function Te() {
    if (J && J.getAudioTracks().length > 0) {
      const Y = J.getAudioTracks()[0];
      Y.enabled = !Y.enabled, t(25, ee = !Y.enabled);
    }
  }
  function Be() {
    return J;
  ...
  const G0 = async () => Ce(), j0 = () => t(17, I = !0), fa = () => t(17, I = !1);
  return n.$$set = (Y) => {
    "mode" in Y && t(2, a = Y.mode), "value" in Y && t(0, i = Y.value), "label" in Y && t(3, l = Y.label), "show_label" in Y && t(4, s = Y.show_label), "rtc_configuration" in Y && t(1, o = Y.rtc_configuration), "i18n" in Y && t(5, u = Y.i18n), "time_limit" in Y && t(6, c = Y.time_limit), "track_constraints" in Y && t(35, d = Y.track_constraints), "rtp_params" in Y && t(36, h = Y.rtp_params), "on_change_cb" in Y && t(7, p = Y.on_change_cb), "reject_cb" in Y && t(37, g = Y.reject_cb), "icon" in Y && t(8, v = Y.icon), "icon_button_color" in Y && t(9, k = Y.icon_button_color), "pulse_color" in Y && t(10, D = Y.pulse_color), "icon_radius" in Y && t(11, y = Y.icon_radius), "button_labels" in Y && t(12, w = Y.button_labels), "variant" in Y && t(13, E = Y.variant), "server" in Y && t(14, L = Y.server);
  }, n.$$.update = () => {
...
function Qw(n, e, t) {
  ...
  } } = e, { button_labels: s } = e, { label: o } = e, { root: u } = e, { show_label: c } = e, { loading_status: d } = e, { height: h } = e, { width: p } = e, { server: g } = e, { container: v = !1 } = e, { scale: k = null } = e, { min_width: D = void 0 } = e, { gradio: y } = e, { rtc_configuration: w } = e, { time_limit: E = null } = e, { modality: S = "video" } = e, { mode: T = "send-receive" } = e, { rtp_params: B = {} } = e, { track_constraints: C = {} } = e, { icon: I = void 0 } = e, { icon_button_color: N = "var(--color-accent)" } = e, { pulse_color: L = "var(--color-accent)" } = e, { icon_radius: q = 50 } = e, { variant: Q = "wave" } = e;
  const z = (O) => {
    ...
    var G0, j0;
    O.status === "failed" && ((G0 = O.meta) === null || G0 === void 0 ? void 0 : G0.error) === "concurrency_limit_reached" ? y.dispatch("error", "Too many concurrent connections. Please try again later!") : O.status === "failed" && ((j0 = O.meta) === null || j0 === void 0 ? void 0 : j0.error) === "connection_already_exists" ? y.dispatch("error", "Connection already exists") : y.dispatch("error", "Unexpected server error");
  }, J = () => y.dispatch("clear_status", d);
  function De(O) {
    l = O, t(0, l);
  }
  const he = () => y.dispatch("tick"), we = ({ detail: O }) => y.dispatch("error", O);
  function ye(O) {
    l = O, t(0, l);
  }
  const ee = () => y.dispatch("tick"), de = ({ detail: O }) => y.dispatch("error", O), fe = (...O) => y.client.stream(...O);
  function Ce(O) {
    l = O, t(0, l);
  }
  const V = () => y.dispatch("clear"), j = () => y.dispatch("play"), pe = () => y.dispatch("pause"), ke = () => y.dispatch("upload"), Te = () => y.dispatch("stop"), Be = () => y.dispatch("end"), Ne = () => y.dispatch("start_recording"), je = () => y.dispatch("stop_recording"), ft = () => y.dispatch("tick"), We = ({ detail: O }) => y.dispatch("error", O);
  function qe(O) {
    l = O, t(0, l);
  }
  const Pe = () => y.dispatch("tick"), lt = ({ detail: O }) => y.dispatch("error", O), qt = ({ detail: O }) => y.dispatch("warning", O);
  return n.$$set = (O) => {
    "elem_id" in O && t(1, r = O.elem_id), "elem_classes" in O && t(2, a = O.elem_classes), "visible" in O && t(3, i = O.visible), "value" in O && t(0, l = O.value), "button_labels" in O && t(4, s = O.button_labels), "label" in O && t(5, o = O.label), "root" in O && t(28, u = O.root), "show_label" in O && t(6, c = O.show_label), "loading_status" in O && t(7, d = O.loading_status), "height" in O && t(8, h = O.height), "width" in O && t(9, p = O.width), "server" in O && t(10, g = O.server), "container" in O && t(11, v = O.container), "scale" in O && t(12, k = O.scale), "min_width" in O && t(13, D = O.min_width), "gradio" in O && t(14, y = O.gradio), "rtc_configuration" in O && t(15, w = O.rtc_configuration), "time_limit" in O && t(16, E = O.time_limit), "modality" in O && t(17, S = O.modality), "mode" in O && t(18, T = O.mode), "rtp_params" in O && t(19, B = O.rtp_params), "track_constraints" in O && t(20, C = O.track_constraints), "icon" in O && t(21, I = O.icon), "icon_button_color" in O && t(22, N = O.icon_button_color), "pulse_color" in O && t(23, L = O.pulse_color), "icon_radius" in O && t(24, q = O.icon_radius), "variant" in O && t(25, Q = O.variant);
  }, [
    l,
    r,
    a,
