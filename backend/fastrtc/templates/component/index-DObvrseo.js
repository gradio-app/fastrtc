...
function Ap(n, e, t) {
  ...
  return n.$$set = (V) => {
    ...
    20979728 && B && h && (d === "pending" || d === "complete") && Dp(B, T), n.$$.dirty[0] & /*status, message*/
...
function lm() {
  ...
  }, d1 = be({}, [...ho, ...mo, ...Lp]), m1 = be({}, [...po, ...Np]), Im = function(M) {
    let W = w(M);
    (!W || !W.tagName) && (W = {
      namespaceURI: W0,
      tagName: "template"
    ...
    if (!(Te && !pe[W] && Vt(ue, W))) {
      if (!(ke && Vt(J, W))) {
        if (!fe[W] || pe[W]) {
          ...
          if (!Vt(ye, Sa($, he, ""))) {
            if (!((W === "src" || W === "xlink:href" || W === "href") && M !== "script" && Mp($, "data:") === 0 && Qt[M])) {
              if (!(Be && !Vt(De, Sa($, he, "")))) {
                if ($)
                  return !1;
              }
  ...
  function w(S) {
    return r(this, void 0, void 0, function* () {
      if (s.length > 0 && S && s.some((B) => S.includes(B.left) && S.includes(B.right)) && T6(g, {
        ...
        if (T.length > 0) {
          yield tv();
          const { default: B } = yield import("./mermaid.core-C7URGBZy.js").then((C) => C.by);
          B.initialize({
            startOnLoad: !1,
...
function tw(n) {
  ...
  return v = new Dd({ props: { fill: "none" } }), {
    ...
    p(L, q) {
      const Q = {};
      q & /*pending*/
      1024 && (Q.submit_btn = !/*pending*/
      L[10]), q & /*pending*/
      1024 && (Q.disabled = /*pending*/
      L[10]), !r && q & /*value*/
      1 && (r = !0, Q.value = /*value*/
      L[0].textbox, Vb(() => r = !1)), t.$set(Q), /*pending*/
      L[10] ? T ? (T.p(L, q), q & /*pending*/
      1024 && mt(T, 1)) : (T = ld(L), T.c(), mt(T, 1), T.m(e, i)) : T && (Al(), Tt(T, 1, 1, () => {
        T = null;
      }), Dl());
      let z = o;
      ...
      L[9] === "send-receive" ? N ? (N.p(L, q), q & /*mode*/
      512 && mt(N, 1)) : (N = sd(L), N.c(), mt(N, 1), N.m(e, h)) : N && (Al(), Tt(N, 1, 1, () => {
        N = null;
      }), Dl()), (!D || q & /*icon_button_color*/
      64 && k !== (k = `fill: ${/*icon_button_color*/
      L[6]}; stroke: ${/*icon_button_color*/
      L[6]}; color: ${/*icon_button_color*/
      L[6]};`)) && dt(g, "style", k), (!D || q & /*stream_state*/
      256) && Ya(
        p,
        "hidden",
        /*stream_state*/
...
function rw(n) {
  ...
  return e = new kd({
    ...
    p(r, [a]) {
      ...
      134225919 && (i.$$scope = { dirty: a, ctx: r }), e.$set(i);
    },
    i(r) {
      t || (mt(e.$$.fragment, r), t = !0);
    },
...
function nw(n, e, t) {
  ...
  const Q = async () => {
    ...
    }), console.log("called submit"), t(0, r.textbox = "", r);
  };
  return n.$$set = (z) => {
    "value" in z && t(0, r = z.value), "rtc_configuration" in z && t(15, a = z.rtc_configuration), "time_limit" in z && t(16, i = z.time_limit), "track_constraints" in z && t(17, l = z.track_constraints), "access_mic" in z && t(18, s = z.access_mic), "start_stream" in z && t(1, o = z.start_stream), "audio_source_callback" in z && t(2, u = z.audio_source_callback), "input_audio_source_callback" in z && t(3, c = z.input_audio_source_callback), "toggleMuteMicrophone" in z && t(19, d = z.toggleMuteMicrophone), "handle_click_outside" in z && t(20, h = z.handle_click_outside), "handle_device_change" in z && t(21, p = z.handle_device_change), "toggleMute" in z && t(4, g = z.toggleMute), "on_change_cb" in z && t(5, v = z.on_change_cb), "trigger_response" in z && t(22, k = z.trigger_response), "icon" in z && t(23, D = z.icon), "icon_button_color" in z && t(6, y = z.icon_button_color), "pulse_color" in z && t(7, w = z.pulse_color), "stream_state" in z && t(8, E = z.stream_state), "mode" in z && t(9, S = z.mode), "pending" in z && t(10, T = z.pending), "mic_accessed" in z && t(24, B = z.mic_accessed), "is_muted" in z && t(11, C = z.is_muted), "is_mic_muted" in z && t(12, I = z.is_mic_muted);
  }, n.$$.update = () => {
    n.$$.dirty & /*value*/
...
function Qw(n, e, t) {
  ...
  const z = (O) => {
    ...
    ) : (O == null ? void 0 : O.type) === "end_stream" ? y.dispatch("warning", O.data) : (O == null ? void 0 : O.type) === "fetch_output" ? y.dispatch("state_change") : (O == null ? void 0 : O.type) === "send_input" ? y.dispatch("tick") : (O == null ? void 0 : O.type) === "submit" ? (console.log("submit in index.svelte", O.data), y.dispatch("submit", O.data)) : (O == null ? void 0 : O.type) === "connection_timeout" && y.dispatch("warning", "Taking a while to connect. Are you on a VPN?"), O.type === "state_change" && y.dispatch(O === "change" ? "state_change" : "tick");
  }, ue = (O) => {
    var G0, j0;
